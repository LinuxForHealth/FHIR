...
package com.ibm.watson.health.fhir.notifications.kafka.impl;
...
import com.ibm.watson.health.fhir.notification.FHIRNotificationEvent;
import com.ibm.watson.health.fhir.notification.FHIRNotificationService;
import com.ibm.watson.health.fhir.notification.FHIRNotificationSubscriber;
import com.ibm.watson.health.fhir.notification.exception.FHIRNotificationException;
import com.ibm.watson.health.fhir.notification.util.FHIRNotificationUtil;
...
public class FHIRNotificationKafkaPublisher implements FHIRNotificationSubscriber {
     ...
     * (non-Javadoc)
     * @see
     * com.ibm.watson.health.fhir.notification.FHIRNotificationSubscriber#notify(com.ibm.watson.health.fhir.notification.
