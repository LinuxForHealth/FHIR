...
import com.ibm.watson.health.fhir.model.resource.Appointment;
...
import com.ibm.watson.health.fhir.model.resource.CoverageEligibilityResponse;
import com.ibm.watson.health.fhir.model.resource.FamilyMemberHistory;
...
import com.ibm.watson.health.fhir.model.resource.RiskAssessment;
import com.ibm.watson.health.fhir.model.resource.Task;
...
import com.ibm.watson.health.fhir.model.type.QuestionnaireItemOperator;
import com.ibm.watson.health.fhir.model.type.QuestionnaireItemType;
...
public class CompleteMockDataCreator extends DataCreatorBase {
            ...
            if (Element.class.isAssignableFrom(parameterType)
                ...
                if (builder.getClass().equals(method.getReturnType())) {
                    ...
                    // md-1:  Max must be postive int or *
                        ...
                        argument = com.ibm.watson.health.fhir.model.type.String.of("*");
                    }
    ...
    protected Element.Builder createPrimitive(Element.Builder builder) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
        if (builder instanceof com.ibm.watson.health.fhir.model.type.Boolean.Builder) {
            handleBoolean((com.ibm.watson.health.fhir.model.type.Boolean.Builder) builder);
        } else if (builder instanceof com.ibm.watson.health.fhir.model.type.Integer.Builder) {
            handleInteger((com.ibm.watson.health.fhir.model.type.Integer.Builder) builder);
        } else if (builder instanceof com.ibm.watson.health.fhir.model.type.Decimal.Builder) {
            handleDecimal((com.ibm.watson.health.fhir.model.type.Decimal.Builder) builder);
        ...
        } else if (builder instanceof com.ibm.watson.health.fhir.model.type.String.Builder) {
            handleString((com.ibm.watson.health.fhir.model.type.String.Builder) builder);
    ...
    protected void handleBoolean(com.ibm.watson.health.fhir.model.type.Boolean.Builder bool) {
        bool.value(podam.manufacturePojo(Boolean.class));
    }
    
    protected void handleId(com.ibm.watson.health.fhir.model.type.Id.Builder string) {
        string.value(podam.manufacturePojo(String.class).replace("_", "-"));
    }
    
    protected void handleString(com.ibm.watson.health.fhir.model.type.String.Builder string) {
        string.value(podam.manufacturePojo(String.class));
    }
    
    protected void handleInteger(com.ibm.watson.health.fhir.model.type.Integer.Builder integer) {
        integer.value(podam.manufacturePojo(Integer.class));
    }
    
    protected void handleDecimal(com.ibm.watson.health.fhir.model.type.Decimal.Builder decimal) {
        decimal.value(podam.manufacturePojo(BigDecimal.class));
    }
    
    private void handleUuid(com.ibm.watson.health.fhir.model.type.Uuid.Builder uuid) {
        uuid.value("urn:uuid:" + UUID.randomUUID().toString());
    }
    
    private void handleOid(com.ibm.watson.health.fhir.model.type.Oid.Builder oid) {
