...
public class CompleteMockDataCreator extends DataCreatorBase {
    ...
    @Override
    protected Builder<?> addData(org.linuxforhealth.fhir.model.type.Reference.Builder builder, String targetProfile) throws Exception {
                    ...
                    // CodeableConcepts with required bindings
                        ...
                        argument = CodeableConcept.builder()
                                .coding(Coding.builder()
                                    ...
                                    .userSelected(org.linuxforhealth.fhir.model.type.Boolean.FALSE)
                                    .build())
                                .text(string(value))
                                .build();
    ...
    protected Element.Builder createPrimitive(Element.Builder builder) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
        if (builder instanceof org.linuxforhealth.fhir.model.type.Boolean.Builder) {
            handleBoolean((org.linuxforhealth.fhir.model.type.Boolean.Builder) builder);
        } else if (builder instanceof org.linuxforhealth.fhir.model.type.Integer.Builder) {
            handleInteger((org.linuxforhealth.fhir.model.type.Integer.Builder) builder);
        } else if (builder instanceof org.linuxforhealth.fhir.model.type.Decimal.Builder) {
            handleDecimal((org.linuxforhealth.fhir.model.type.Decimal.Builder) builder);
        ...
        } else if (builder instanceof org.linuxforhealth.fhir.model.type.String.Builder) {
            handleString((org.linuxforhealth.fhir.model.type.String.Builder) builder);
    ...
    protected void handleBoolean(org.linuxforhealth.fhir.model.type.Boolean.Builder bool) {
        bool.value(podam.manufacturePojo(Boolean.class));
    }

    protected void handleId(org.linuxforhealth.fhir.model.type.Id.Builder string) {
        string.value(podam.manufacturePojo(String.class).replace("_", "-"));
    }

    protected void handleString(org.linuxforhealth.fhir.model.type.String.Builder string) {
        string.value(podam.manufacturePojo(String.class));
    }

    protected void handleInteger(org.linuxforhealth.fhir.model.type.Integer.Builder integer) {
        integer.value(podam.manufacturePojo(Integer.class));
    }

    protected void handleDecimal(org.linuxforhealth.fhir.model.type.Decimal.Builder decimal) {
        decimal.value(podam.manufacturePojo(BigDecimal.class));
    }

    private void handleUuid(org.linuxforhealth.fhir.model.type.Uuid.Builder uuid) {
        uuid.value("urn:uuid:" + UUID.randomUUID().toString());
    }

    private void handleOid(org.linuxforhealth.fhir.model.type.Oid.Builder oid) {
