...
package com.ibm.watson.health.fhir.schema.derby;
...
import com.ibm.watson.health.database.utils.derby.DerbyMaster;
...
public class DerbyFhirDatabase implements AutoCloseable, IConnectionProvider {
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.database.utils.api.IConnectionProvider#commitTransaction()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.database.utils.api.IConnectionProvider#describe(java.lang.String, java.lang.StringBuilder, java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.database.utils.api.IConnectionProvider#getConnection()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.database.utils.api.IConnectionProvider#getTranslator()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.database.utils.api.IConnectionProvider#rollbackTransaction()
     */
    @Override
