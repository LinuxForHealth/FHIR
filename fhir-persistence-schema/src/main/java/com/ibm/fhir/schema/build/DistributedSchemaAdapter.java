 ...
 */
public class DistributedSchemaAdapter extends FhirSchemaAdapter {
     ...
     */
    public DistributedSchemaAdapter(IDatabaseAdapter databaseAdapter, String distributionColumnName) {
