 ...
 * part of the schema migration step for schema version V0010.
...
public class InitializeLogicalIdIsDeleted implements IDatabaseStatement {
    ...
    public void run(IDatabaseTranslator translator, Connection c) {
        ...
        // Correlated update to grab the IS_DELETED value from xxx_RESOURCES and use it to
        // set xxx_LOGICAL_RESOURCES.IS_DELETE for the current_resource_id.
        final String DML = "UPDATE " + lrTable + " lr "
                + " SET lr.is_deleted = (SELECT r.is_deleted FROM " + rTable + " r WHERE r.resource_id = lr.current_resource_id)"
                ;
