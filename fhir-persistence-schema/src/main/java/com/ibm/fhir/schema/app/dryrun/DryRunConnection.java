...
/**
 * Wrapping of a real database connection so that we can intercept the calls
 * that change the database.
 */
public class DryRunConnection implements Connection {
     ...
     * @param wrappee
     */
    public DryRunConnection(Connection wrappee) {
