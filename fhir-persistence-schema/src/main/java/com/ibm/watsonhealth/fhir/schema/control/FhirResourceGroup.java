...
public class FhirResourceGroup {
    ...
    public FhirResourceGroup(PhysicalDataModel model, String schemaName, SessionVariableDef sessionVariable,
        ...
        // The admin schema (where the tenants table resides)
        this.adminSchemaName = sessionVariable.getSchemaName();
    }
    ...
    public void addLogicalResources(List<IDatabaseObject> group, String prefix) {
        ...
        Table tbl = Table.builder(schemaName, tableName)
                ...
                .addPrimaryKey(tableName + "_PK", TENANT_ID, LOGICAL_RESOURCE_ID)
                .addForeignKeyConstraint(FK + tableName + "_TID", adminSchemaName, TENANTS, TENANT_ID)
  ...
  CREATE UNIQUE INDEX device_resource_prf_in1    ON device_resources (resource_id) INCLUDE (logical_resource_id, version_id, is_deleted);
    ...
    public void addResources(List<IDatabaseObject> group, String prefix) {
        ...
        String[] prfIndexCols = {TENANT_ID, RESOURCE_ID};
        ...
        Table tbl = Table.builder(schemaName, tableName)
                ...
                .addVarcharColumn(TENANT_DATA_ID, 36, false)      
                ...
                .addPrimaryKey(tableName + "_PK", TENANT_ID, RESOURCE_ID)
                .setTablespace(fhirTablespace)
                .addPartitionDef(TENANT_ID, PART_LOWER, PART_UPPER)
                .addPrivileges(resourceTablePrivileges)
                .enableAccessControl(this.sessionVariable)
...
ALTER TABLE device_str_values ADD CONSTRAINT fk_device_str_values_rid  FOREIGN KEY (resource_id) REFERENCES device_resources;
    ...
    public void addStrValues(List<IDatabaseObject> group, String prefix) {
        ...
        Table tbl = Table.builder(schemaName, tableName)
                ...
                .addBigIntColumn(        RESOURCE_ID,      false)
                .addPartitionDef(TENANT_ID, PART_LOWER, PART_UPPER)
                .addIndex(IDX + tableName + "_PSR", TENANT_ID, PARAMETER_NAME_ID, STR_VALUE, RESOURCE_ID)
                .addIndex(IDX + tableName + "_PLR", TENANT_ID, PARAMETER_NAME_ID, STR_VALUE_LCASE, RESOURCE_ID)
                .addIndex(IDX + tableName + "_RPS", TENANT_ID, RESOURCE_ID, PARAMETER_NAME_ID, STR_VALUE)
                .addIndex(IDX + tableName + "_RPL", TENANT_ID, RESOURCE_ID, PARAMETER_NAME_ID, STR_VALUE_LCASE)
                .addForeignKeyConstraint(FK + tableName + "_PNID", schemaName, PARAMETER_NAMES, TENANT_ID, PARAMETER_NAME_ID)
                .addForeignKeyConstraint(FK + tableName + "_RID", schemaName, resourcesTable, TENANT_ID, RESOURCE_ID)
                .setTablespace(fhirTablespace)
                .addPrivileges(resourceTablePrivileges)
                .enableAccessControl(this.sessionVariable)
                .build(model)
...
ALTER TABLE device_token_values ADD CONSTRAINT fk_device_token_values_r  FOREIGN KEY (resource_id)       REFERENCES device_resources;
    ...
    public void addTokenValues(List<IDatabaseObject> group, String prefix) {
        ...
        Table tbl = Table.builder(schemaName, tableName)
                ...
                .addBigIntColumn(        RESOURCE_ID,      false)
                .addIndex(IDX + tableName + "_PNCSCV", TENANT_ID, PARAMETER_NAME_ID, CODE_SYSTEM_ID, TOKEN_VALUE, RESOURCE_ID)
                .addIndex(IDX + tableName + "_RPS", TENANT_ID, RESOURCE_ID, PARAMETER_NAME_ID, CODE_SYSTEM_ID, TOKEN_VALUE)
                .addForeignKeyConstraint(FK + tableName + "_PN", schemaName, PARAMETER_NAMES, TENANT_ID, PARAMETER_NAME_ID)
                .addForeignKeyConstraint(FK + tableName + "_CS", schemaName, CODE_SYSTEMS, TENANT_ID, CODE_SYSTEM_ID)
                .addForeignKeyConstraint(FK + tableName + "_R", schemaName, resourcesTable, TENANT_ID, RESOURCE_ID)
                .addPartitionDef(TENANT_ID, PART_LOWER, PART_UPPER)
                .setTablespace(fhirTablespace)
                .addPrivileges(resourceTablePrivileges)
                .enableAccessControl(this.sessionVariable)
...
ALTER TABLE device_date_values ADD CONSTRAINT fk_device_date_values_r  FOREIGN KEY (resource_id)       REFERENCES device_resources;
    ...
    public void addDateValues(List<IDatabaseObject> group, String prefix) {
        ...
        Table tbl = Table.builder(schemaName, tableName)
                ...
                .addBigIntColumn(        RESOURCE_ID,      false)
                .addIndex(IDX + tableName + "_PVR", TENANT_ID, PARAMETER_NAME_ID, DATE_VALUE, RESOURCE_ID)
                .addIndex(IDX + tableName + "_RPV", TENANT_ID, RESOURCE_ID, PARAMETER_NAME_ID, DATE_VALUE)
                .addIndex(IDX + tableName + "_PSER", TENANT_ID, PARAMETER_NAME_ID, DATE_START, DATE_END, RESOURCE_ID)
                .addIndex(IDX + tableName + "_PESR", TENANT_ID, PARAMETER_NAME_ID, DATE_END, DATE_START, RESOURCE_ID)
                .addIndex(IDX + tableName + "_RPSE", TENANT_ID, RESOURCE_ID, PARAMETER_NAME_ID, DATE_START, DATE_END)
                .addForeignKeyConstraint(FK + tableName + "_PN", schemaName, PARAMETER_NAMES, TENANT_ID, PARAMETER_NAME_ID)
                .addForeignKeyConstraint(FK + tableName + "_R", schemaName, resourcesTable, TENANT_ID, RESOURCE_ID)
                .addPartitionDef(TENANT_ID, PART_LOWER, PART_UPPER)
                .setTablespace(fhirTablespace)
...
ALTER TABLE device_number_values ADD CONSTRAINT fk_device_number_values_r  FOREIGN KEY (resource_id)       REFERENCES device_resources ON DELETE CASCADE;
    ...
    public void addNumberValues(List<IDatabaseObject> group, String prefix) {
        ...
        Table tbl = Table.builder(schemaName, tableName)
                ...
                .addBigIntColumn(        RESOURCE_ID,      false)
                .addPartitionDef(TENANT_ID, PART_LOWER, PART_UPPER)
                .addIndex(IDX + tableName + "_PNNV", TENANT_ID, PARAMETER_NAME_ID, NUMBER_VALUE, RESOURCE_ID)
                .addIndex(IDX + tableName + "_RPS", TENANT_ID, RESOURCE_ID, PARAMETER_NAME_ID, NUMBER_VALUE)
                .addForeignKeyConstraint(FK + tableName + "_PN", schemaName, PARAMETER_NAMES, TENANT_ID, PARAMETER_NAME_ID)
                .addForeignKeyConstraint(FK + tableName + "_RID", schemaName, resourcesTable, TENANT_ID, RESOURCE_ID)
                .setTablespace(fhirTablespace)
                .addPrivileges(resourceTablePrivileges)
...
ALTER TABLE device_latlng_values ADD CONSTRAINT fk_device_latlng_values_r  FOREIGN KEY (resource_id)       REFERENCES device_resources;
    ...
    public void addLatLngValues(List<IDatabaseObject> group, String prefix) {
        ...
        Table tbl = Table.builder(schemaName, tableName)
                ...
                .addBigIntColumn(        RESOURCE_ID,      false)
                .addPartitionDef(TENANT_ID, PART_LOWER, PART_UPPER)
                .addIndex(IDX + tableName + "_PNNLV", TENANT_ID, PARAMETER_NAME_ID, LATITUDE_VALUE, RESOURCE_ID)
                .addIndex(IDX + tableName + "_PNNHV", TENANT_ID, PARAMETER_NAME_ID, LONGITUDE_VALUE, RESOURCE_ID)
                .addIndex(IDX + tableName + "_RPLAT", TENANT_ID, RESOURCE_ID, PARAMETER_NAME_ID, LATITUDE_VALUE)
                .addIndex(IDX + tableName + "_RPLNG", TENANT_ID, RESOURCE_ID, PARAMETER_NAME_ID, LONGITUDE_VALUE)
                .addForeignKeyConstraint(FK + tableName + "_PN", schemaName, PARAMETER_NAMES, TENANT_ID, PARAMETER_NAME_ID)
                .addForeignKeyConstraint(FK + tableName + "_RID", schemaName, resourcesTable, TENANT_ID, RESOURCE_ID)
                .setTablespace(fhirTablespace)
                .addPrivileges(resourceTablePrivileges)
...
ALTER TABLE device_quantity_values ADD CONSTRAINT fk_device_quantity_values_r  FOREIGN KEY (resource_id)       REFERENCES device_resources ON DELETE CASCADE;
    ...
    public void addQuantityValues(List<IDatabaseObject> group, String prefix) {
        ...
        Table tbl = Table.builder(schemaName, tableName)
                ...
                .addBigIntColumn(        RESOURCE_ID,      false)
                .addIndex(IDX + tableName + "_PNNV", TENANT_ID, PARAMETER_NAME_ID, CODE, QUANTITY_VALUE, RESOURCE_ID, CODE_SYSTEM_ID)
                .addIndex(IDX + tableName + "_RPS", TENANT_ID, RESOURCE_ID, PARAMETER_NAME_ID, CODE, QUANTITY_VALUE, CODE_SYSTEM_ID)
                .addIndex(IDX + tableName + "_PCLHSR", TENANT_ID, PARAMETER_NAME_ID, CODE, QUANTITY_VALUE_LOW, QUANTITY_VALUE_HIGH, CODE_SYSTEM_ID, RESOURCE_ID)
                .addIndex(IDX + tableName + "_PCHLSR", TENANT_ID, PARAMETER_NAME_ID, CODE, QUANTITY_VALUE_HIGH, QUANTITY_VALUE_LOW, CODE_SYSTEM_ID, RESOURCE_ID)
                .addIndex(IDX + tableName + "_RPCLHS", TENANT_ID, RESOURCE_ID, PARAMETER_NAME_ID, CODE, QUANTITY_VALUE_LOW, QUANTITY_VALUE_HIGH, CODE_SYSTEM_ID)
                .addIndex(IDX + tableName + "_RPCHLS", TENANT_ID, RESOURCE_ID, PARAMETER_NAME_ID, CODE, QUANTITY_VALUE_HIGH, QUANTITY_VALUE_LOW, CODE_SYSTEM_ID)
                .addForeignKeyConstraint(FK + tableName + "_PN", schemaName, PARAMETER_NAMES, TENANT_ID, PARAMETER_NAME_ID)
                .addForeignKeyConstraint(FK + tableName + "_R", schemaName, resourcesTable, TENANT_ID, RESOURCE_ID)
                .addPartitionDef(TENANT_ID, PART_LOWER, PART_UPPER)
                .setTablespace(fhirTablespace)
