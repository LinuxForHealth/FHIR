...
package com.ibm.watson.health.fhir.model.plugin.generator;

import org.apache.maven.plugin.logging.Log;

import com.ibm.watson.health.fhir.model.plugin.generator.impl.R4ModelGeneratorImpl;
...
public class ModelFactory {
    ...
    public static ModelGenerator getModelGenerator(String generatorVersion, Log log) {
        ...
        //Default is R4
        ModelGenerator generator = new R4ModelGeneratorImpl();
        if("r4".compareTo(generatorVersion)!=0) {
            // Not the default 
            try {
