...
public class JDBCQueryBuilder extends AbstractJDBCQueryBuilder<String, JDBCOperator> {
    ...
    /* (non-Javadoc)
     * @see com.ibm.fhir.persistence.util.QueryBuilder#buildQuery(java.lang.Class, com.ibm.fhir.search.context.FHIRSearchContext)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.fhir.persistence.util.AbstractQueryBuilder#getOperator(com.ibm.fhir.search.Parameter)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.fhir.persistence.util.AbstractQueryBuilder#getPrefixOperator(com.ibm.fhir.search.ParameterValue)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.fhir.persistence.util.AbstractQueryBuilder#processStringParm(com.ibm.fhir.search.Parameter)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.fhir.persistence.util.AbstractQueryBuilder#processReferenceParm(com.ibm.fhir.search.Parameter)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.fhir.persistence.util.AbstractQueryBuilder#processDateParm(com.ibm.fhir.search.Parameter)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.fhir.persistence.util.AbstractQueryBuilder#processTokenParm(com.ibm.fhir.search.Parameter)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.fhir.persistence.util.AbstractQueryBuilder#processNumberParm(com.ibm.fhir.search.Parameter)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.fhir.persistence.util.AbstractQueryBuilder#processQuantityParm(java.lang.Class, com.ibm.fhir.search.Parameter)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.fhir.persistence.jdbc.util.AbstractJDBCQueryBuilder#processMissingParm(java.lang.Class, com.ibm.fhir.search.Parameter, java.lang.String)
     */
    @Override
