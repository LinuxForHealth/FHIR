...
public class LocationBehaviorUtil {
    ...
    public void buildLocationSearchQuery(StringBuilder whereClauseSegment, List<Object> bindVariables, List<BoundingRadius> boundingRads){
        ...
        for(BoundingRadius rad : boundingRads) {
