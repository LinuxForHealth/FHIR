...
public class JDBCNormalizedQueryBuilder extends AbstractJDBCQueryBuilder<SqlQueryData, JDBCOperator> {
     ...
     *      WHERE R.RESOURCE_ID = LR.CURRENT_RESOURCE_ID AND R.IS_DELETED &lt;&rt; 'Y' AND P1.LOGICAL_RESOURCE_ID = R.LOGICAL_RESOURCE_ID AND
     ...
     *      CLR1.CURRENT_RESOURCE_ID AND CR1.IS_DELETED &lt;&rt; 'Y' AND CP1.LOGICAL_RESOURCE_ID = CR1.LOGICAL_RESOURCE_ID AND
     ...
     *      CLR2.CURRENT_RESOURCE_ID AND CR2.IS_DELETED &lt;&rt; 'Y' AND CP2.LOGICAL_RESOURCE_ID = CR2.LOGICAL_RESOURCE_ID AND
     ...
     *      AuditEvent_STR_VALUES P1 WHERE R.RESOURCE_ID = LR.CURRENT_RESOURCE_ID AND R.IS_DELETED &lt;&rt; 'Y' AND
     ...
     *      Device_RESOURCES CR1, Device_LOGICAL_RESOURCES CLR1, Device_STR_VALUES CP1 WHERE CR1.RESOURCE_ID =
     *      CLR1.CURRENT_RESOURCE_ID AND CR1.IS_DELETED &lt;&rt; 'Y' AND CP1.LOGICAL_RESOURCE_ID = CLR1.LOGICAL_RESOURCE_ID AND
     ...
     *      CLR1, RelatedPerson_STR_VALUES CP1 WHERE CR1.RESOURCE_ID = CLR1.CURRENT_RESOURCE_ID AND CR1.IS_DELETED &lt;&rt;
