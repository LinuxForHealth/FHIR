...
public class JDBCQueryBuilder extends AbstractJDBCQueryBuilder<String, JDBCOperator> {
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.util.QueryBuilder#buildQuery(java.lang.Class, com.ibm.watson.health.fhir.search.context.FHIRSearchContext)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.util.AbstractQueryBuilder#getOperator(com.ibm.watson.health.fhir.search.Parameter)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.util.AbstractQueryBuilder#getPrefixOperator(com.ibm.watson.health.fhir.search.ParameterValue)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.util.AbstractQueryBuilder#processStringParm(com.ibm.watson.health.fhir.search.Parameter)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.util.AbstractQueryBuilder#processReferenceParm(com.ibm.watson.health.fhir.search.Parameter)
     */
    @Override
    protected String processReferenceParm(Class<?> resourceType, Parameter queryParm, String tableAlias) throws Exception {
        ...
        for (ParameterValue value : queryParm.getValues()) {
            ...
            if (referenceValueParts.length == 2 && FHIRUtil.isStandardResourceType(referenceValueParts[0])) {
                ...
                List<ResourceType> targets = definition.getTarget();
                if (targets.size() == 1) {
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.util.AbstractQueryBuilder#processDateParm(com.ibm.watson.health.fhir.search.Parameter)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.util.AbstractQueryBuilder#processTokenParm(com.ibm.watson.health.fhir.search.Parameter)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.util.AbstractQueryBuilder#processNumberParm(com.ibm.watson.health.fhir.search.Parameter)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.util.AbstractQueryBuilder#processQuantityParm(java.lang.Class, com.ibm.watson.health.fhir.search.Parameter)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.jdbc.util.AbstractJDBCQueryBuilder#processMissingParm(java.lang.Class, com.ibm.watson.health.fhir.search.Parameter, java.lang.String)
     */
    @Override
