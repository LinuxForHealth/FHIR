...
import com.ibm.watson.health.fhir.persistence.jdbc.dto.Parameter.TimeType;
...
public class JDBCParameterBuilder extends AbstractProcessor<List<Parameter>> {
    ...
    @Override
    public List<Parameter> process(SearchParameter parameter, com.ibm.watson.health.fhir.model.path.FHIRPathQuantityNode value)
        throws FHIRPersistenceProcessorException {
        return process(parameter, (FHIRPathAbstractNode) value);
    }
    ...
    @Override
    public List<Parameter> process(SearchParameter parameter, com.ibm.watson.health.fhir.model.type.String value) throws FHIRPersistenceProcessorException {
        String methodName = "process(SearchParameter,String)";
        log.entering(CLASSNAME, methodName);
        List<Parameter> parameters = new ArrayList<>();
        try {
    ...
    public List<Parameter> process(SearchParameter parameter, Address value) throws FHIRPersistenceProcessorException {
        ...
        try {
            ...
            if (value.getLine() != null) {
                for (com.ibm.watson.health.fhir.model.type.String aLine : value.getLine()) {
                    p = new Parameter();
                    p.setName(paramName);
    ...
    public List<Parameter> process(SearchParameter parameter, HumanName value) throws FHIRPersistenceProcessorException {
        ...
        try {
            ...
            if (value.getGiven() != null) {
                for (com.ibm.watson.health.fhir.model.type.String given : value.getGiven()) {
                    p = new Parameter();
                    p.setName(paramname);
    ...
    /*
     * (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.util.Processor#process(com.ibm.watson.health.fhir.model.resource.
     * SearchParameter, com.ibm.watson.health.fhir.model.type.BackboneElement)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.util.Processor#process(com.ibm.watson.health.fhir.model.resource.
     * SearchParameter, com.ibm.watson.health.fhir.model.type.ContactDetail)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.util.Processor#process(com.ibm.watson.health.fhir.model.resource.
     * SearchParameter, com.ibm.watson.health.fhir.model.type.Contributor)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.util.Processor#process(com.ibm.watson.health.fhir.model.resource.
     * SearchParameter, com.ibm.watson.health.fhir.model.type.DataRequirement)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.util.Processor#process(com.ibm.watson.health.fhir.model.resource.
     * SearchParameter, com.ibm.watson.health.fhir.model.type.Expression)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.util.Processor#process(com.ibm.watson.health.fhir.model.resource.
     * SearchParameter, com.ibm.watson.health.fhir.model.type.Money)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.util.Processor#process(com.ibm.watson.health.fhir.model.resource.
     * SearchParameter, com.ibm.watson.health.fhir.model.type.Narrative)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.util.Processor#process(com.ibm.watson.health.fhir.model.resource.
     * SearchParameter, com.ibm.watson.health.fhir.model.type.ParameterDefinition)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.util.Processor#process(com.ibm.watson.health.fhir.model.resource.
     * SearchParameter, com.ibm.watson.health.fhir.model.type.RelatedArtifact)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.util.Processor#process(com.ibm.watson.health.fhir.model.resource.
     * SearchParameter, com.ibm.watson.health.fhir.model.type.TriggerDefinition)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.util.Processor#process(com.ibm.watson.health.fhir.model.resource.
     * SearchParameter, com.ibm.watson.health.fhir.model.type.UsageContext)
     */
    @Override
