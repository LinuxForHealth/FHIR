...
import com.ibm.watson.health.fhir.persistence.jdbc.util.CodeSystemsCacheUpdater;
import com.ibm.watson.health.fhir.persistence.jdbc.util.ParameterNamesCache;
import com.ibm.watson.health.fhir.persistence.jdbc.util.ParameterNamesCacheUpdater;
import com.ibm.watson.health.fhir.persistence.jdbc.util.SQLParameterEncoder;
import com.ibm.watson.health.fhir.persistence.util.AbstractQueryBuilder;
...
public class ParameterDAONormalizedImpl extends FHIRDbDAOBasicImpl<Parameter> implements ParameterNormalizedDAO {
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.jdbc.dao.api.ParameterDAO#insert(java.util.List)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.jdbc.dao.api.ParameterNormalizedDAO#readParameterNameId(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.jdbc.dao.api.ParameterNormalizedDAO#readCodeSystemId(java.lang.String)
     */
    @Override
