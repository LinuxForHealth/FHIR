...
package com.ibm.watson.health.fhir.persistence.jdbc.impl;

import static com.ibm.watson.health.fhir.config.FHIRConfiguration.PROPERTY_JDBC_ENABLE_CODE_SYSTEMS_CACHE;
import static com.ibm.watson.health.fhir.config.FHIRConfiguration.PROPERTY_JDBC_ENABLE_PARAMETER_NAMES_CACHE;
import static com.ibm.watson.health.fhir.config.FHIRConfiguration.PROPERTY_JDBC_ENABLE_RESOURCE_TYPES_CACHE;
import static com.ibm.watson.health.fhir.config.FHIRConfiguration.PROPERTY_REPL_INTERCEPTOR_ENABLED;
...
import com.ibm.watson.health.fhir.persistence.jdbc.dao.api.ParameterDAO;
...
import com.ibm.watson.health.fhir.persistence.jdbc.dao.impl.ParameterDAONormalizedImpl;
import com.ibm.watson.health.fhir.persistence.jdbc.dao.impl.ResourceDAONormalizedImpl;
...
import com.ibm.watson.health.fhir.persistence.jdbc.exception.FHIRPersistenceFKVException;
import com.ibm.watson.health.fhir.persistence.jdbc.util.CodeSystemsCache;
import com.ibm.watson.health.fhir.persistence.jdbc.util.JDBCNormalizedQueryBuilder;
import com.ibm.watson.health.fhir.persistence.jdbc.util.JDBCParameterBuilder;
import com.ibm.watson.health.fhir.persistence.jdbc.util.ParameterNamesCache;
import com.ibm.watson.health.fhir.persistence.jdbc.util.ResourceTypesCache;
import com.ibm.watson.health.fhir.persistence.jdbc.util.SqlQueryData;
...
import com.ibm.watson.health.fhir.replication.api.util.ReplicationUtil;
...
public class FHIRPersistenceJDBCNormalizedImpl extends FHIRPersistenceJDBCImpl implements FHIRPersistence, FHIRPersistenceTransaction {
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.FHIRPersistence#isDeleteSupported()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.FHIRPersistence#create(com.ibm.watson.health.fhir.persistence.context.FHIRPersistenceContext, com.ibm.watson.health.fhir.model.Resource)
     */
    @Override
    public Resource create(FHIRPersistenceContext context, Resource resource) throws FHIRPersistenceException  {
        ...
        try {
            ...
            com.ibm.watson.health.fhir.persistence.jdbc.dto.Resource resourceDTO = new com.ibm.watson.health.fhir.persistence.jdbc.dto.Resource();
...
//            log.log(Level.SEVERE, this.performCacheDiagnostics());
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.FHIRPersistence#update(com.ibm.watson.health.fhir.persistence.context.FHIRPersistenceContext, java.lang.String, com.ibm.watson.health.fhir.model.Resource)
     */
    @Override
    public Resource update(FHIRPersistenceContext context, String logicalId, Resource resource) throws FHIRPersistenceException {
        ...
        com.ibm.watson.health.fhir.persistence.jdbc.dto.Resource existingResourceDTO;
        ByteArrayOutputStream stream = new ByteArrayOutputStream();
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.FHIRPersistence#search(com.ibm.watson.health.fhir.persistence.context.FHIRPersistenceContext, java.lang.Class)
     */
    @Override
    public List<Resource> search(FHIRPersistenceContext context, Class<? extends Resource> resourceType)
        ...
        List<com.ibm.watson.health.fhir.persistence.jdbc.dto.Resource> unsortedResultsList;
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.FHIRPersistence#delete(com.ibm.watson.health.fhir.persistence.context.FHIRPersistenceContext, Class<? extends Resource> resourceType, java.lang.String)
     */
    @Override
    public Resource delete(FHIRPersistenceContext context, Class<? extends Resource> resourceType, String logicalId) throws FHIRPersistenceException {
        ...
        com.ibm.watson.health.fhir.persistence.jdbc.dto.Resource existingResourceDTO = null;
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.FHIRPersistence#read(com.ibm.watson.health.fhir.persistence.context.FHIRPersistenceContext, java.lang.Class, java.lang.String)
     */
    @Override
    public Resource read(FHIRPersistenceContext context, Class<? extends Resource> resourceType, String logicalId)
        ...
        com.ibm.watson.health.fhir.persistence.jdbc.dto.Resource resourceDTO = null;
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.FHIRPersistence#history(com.ibm.watson.health.fhir.persistence.context.FHIRPersistenceContext, java.lang.Class, java.lang.String)
     */
    @Override
    public List<Resource> history(FHIRPersistenceContext context, Class<? extends Resource> resourceType,
        ...
        List<com.ibm.watson.health.fhir.persistence.jdbc.dto.Resource> resourceDTOList;
        ...
        try {
            ...
            if (resourceCount > 0) {
                ...
                for (com.ibm.watson.health.fhir.persistence.jdbc.dto.Resource resourceDTO : resourceDTOList) {
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.FHIRPersistence#vread(com.ibm.watson.health.fhir.persistence.context.FHIRPersistenceContext, java.lang.Class, java.lang.String, java.lang.String)
     */
    @Override
     ...
     */
    @Override
    protected List<com.ibm.watson.health.fhir.persistence.jdbc.dto.Resource> getResourceDTOs(
     ...
     * @throws IOException 
     */
    protected List<Resource> convertResourceDTOList(List<com.ibm.watson.health.fhir.persistence.jdbc.dto.Resource> resourceDTOList, 
   ...
   /**
     ...
     * @throws Exception 
     */
    private List<Parameter> extractSearchParameters(Resource fhirResource, com.ibm.watson.health.fhir.persistence.jdbc.dto.Resource resourceDTO) 
                 throws Exception {
