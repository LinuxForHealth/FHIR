...
public class NewNumberParmBehaviorUtilTest {
    private static final Logger log = java.util.logging.Logger.getLogger(NewNumberParmBehaviorUtilTest.class.getName());
    ...
    private void runTest(QueryParameter queryParm, List<Object> expectedBindVariables, String expectedSql,
        ...
        if (log.isLoggable(LOG_LEVEL)) {
            ...
            log.info("bind variables -> " + collectBindMarkersInto);
        }
    ...
    public void testPrecisionWithExact() throws FHIRPersistenceException {
        ...
        expectedBindVariables.add(new BigDecimal("1E+3"));
        String expectedSql = "(Basic.NUMBER_VALUE > ? OR Basic.NUMBER_VALUE_HIGH > ?)";
        ...
        expectedBindVariables.add(new BigDecimal("1E+3"));
        expectedBindVariables.add(new BigDecimal("1E+3"));
        expectedSql = "(Basic.NUMBER_VALUE < ? OR Basic.NUMBER_VALUE_LOW < ?)";
        runTest(queryParm, expectedBindVariables, expectedSql);
        ...
        expectedBindVariables.add(new BigDecimal("1E+3"));
        expectedBindVariables.add(new BigDecimal("1E+3"));
        expectedSql = "(Basic.NUMBER_VALUE >= ? OR Basic.NUMBER_VALUE_HIGH >= ?)";
        runTest(queryParm, expectedBindVariables, expectedSql);
    ...
    public void testPrecisionWithNotEqual() throws FHIRPersistenceException {
        ...
        expectedBindVariables.add(new BigDecimal(99.5));
        expectedBindVariables.add(new BigDecimal(100.5));
        String expectedSql = "(Basic.NUMBER_VALUE < ? OR Basic.NUMBER_VALUE >= ? OR Basic.NUMBER_VALUE_LOW < ? OR Basic.NUMBER_VALUE_HIGH > ?)";
        runTest(queryParm, expectedBindVariables, expectedSql);
    }
    ...
    public void testPrecisionIntegerWithEQ() throws FHIRPersistenceException {
        ...
        expectedBindVariables.add(new BigDecimal("0.5"));
        expectedBindVariables.add(new BigDecimal("1.5"));
        String expectedSql = "(MolecularSequence.NUMBER_VALUE >= ? AND MolecularSequence.NUMBER_VALUE < ? "
    ...
    public void testPrecisionIntegerWithNE() throws FHIRPersistenceException {
        ...
        expectedBindVariables.add(new BigDecimal("0.5"));
        expectedBindVariables.add(new BigDecimal("1.5"));
        String expectedSql = "(MolecularSequence.NUMBER_VALUE < ? OR MolecularSequence.NUMBER_VALUE >= ? "
