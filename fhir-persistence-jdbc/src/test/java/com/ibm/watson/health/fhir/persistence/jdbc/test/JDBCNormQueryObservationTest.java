...
import com.ibm.watson.health.fhir.persistence.test.common.AbstractQueryObservationTest;


public class JDBCNormQueryObservationTest extends AbstractQueryObservationTest {
    
    private Properties testProps;
    
    public JDBCNormQueryObservationTest() throws Exception {
