...
import com.ibm.watson.health.fhir.persistence.test.common.AbstractQueryIncludeTest;


public class JDBCNormQueryIncludeTest extends AbstractQueryIncludeTest {
    
    private Properties testProps;
    
    public JDBCNormQueryIncludeTest() throws Exception {
