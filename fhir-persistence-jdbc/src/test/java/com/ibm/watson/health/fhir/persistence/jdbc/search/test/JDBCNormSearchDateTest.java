...
import com.ibm.watson.health.fhir.persistence.search.test.AbstractSearchDateTest;
...
public class JDBCNormSearchDateTest extends AbstractSearchDateTest {
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.search.test.AbstractSearchDateTest#testCreateBasicResource()
     */
    @Override
    @Test
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.search.test.AbstractSearchDateTest#testSearchDate_date()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.search.test.AbstractSearchDateTest#testSearchDate_Period()
     */
    @Override
    @Test(dependsOnMethods = { "testCreateBasicResource" })
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.search.test.AbstractSearchDateTest#testSearchDate_Period_NoStart()
     */
    @Override
    @Test(dependsOnMethods = { "testCreateBasicResource" })
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.search.test.AbstractSearchDateTest#testSearchDate_Period_NoEnd()
     */
    @Override
    @Test(dependsOnMethods = { "testCreateBasicResource" })
