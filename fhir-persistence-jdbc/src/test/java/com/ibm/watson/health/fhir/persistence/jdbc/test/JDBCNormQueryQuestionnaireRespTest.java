...
import com.ibm.watson.health.fhir.persistence.test.common.AbstractQueryQuestionnaireRespTest;


public class JDBCNormQueryQuestionnaireRespTest extends AbstractQueryQuestionnaireRespTest {
    
    private Properties testProps;
    
    public JDBCNormQueryQuestionnaireRespTest() throws Exception {
