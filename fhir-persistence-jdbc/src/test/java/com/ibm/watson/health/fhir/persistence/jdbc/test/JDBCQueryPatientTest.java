...
import com.ibm.watson.health.fhir.persistence.test.common.AbstractQueryPatientTest;


public class JDBCQueryPatientTest extends AbstractQueryPatientTest {
    
    private Properties testProps;
    
    public JDBCQueryPatientTest() throws Exception {
