...
import com.ibm.watson.health.fhir.persistence.test.common.AbstractQueryImmunizationTest;


public class JDBCNormQueryImmunizationTest extends AbstractQueryImmunizationTest {
    
    private Properties testProps;
    
    public JDBCNormQueryImmunizationTest() throws Exception {
