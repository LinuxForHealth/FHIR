...
import com.ibm.watson.health.fhir.persistence.test.common.AbstractQueryImmunizationRecommendationTest;


public class JDBCQueryImmunizationRecommendationTest extends AbstractQueryImmunizationRecommendationTest {
    
    private Properties testProps;
    
    public JDBCQueryImmunizationRecommendationTest() throws Exception {
