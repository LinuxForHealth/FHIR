...
import com.ibm.watson.health.fhir.persistence.test.common.AbstractQueryMedicationAdministrationTest;


public class JDBCQueryMedicationAdministrationTest extends AbstractQueryMedicationAdministrationTest {
    
    private Properties testProps;
    
    public JDBCQueryMedicationAdministrationTest() throws Exception {
