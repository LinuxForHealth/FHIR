...
import com.ibm.watson.health.fhir.persistence.test.common.AbstractQuerySortTest;


public class JDBCQuerySortTest extends AbstractQuerySortTest {
    
    private Properties testProps;
    
    public JDBCQuerySortTest() throws Exception {
