...
import com.ibm.watson.health.fhir.persistence.test.common.AbstractQueryChainedParmTest;


public class JDBCQueryChainedParmTest extends AbstractQueryChainedParmTest {
    
    private Properties testProps;
    
    public JDBCQueryChainedParmTest() throws Exception {
