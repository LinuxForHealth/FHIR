...
import com.ibm.watson.health.fhir.persistence.test.common.AbstractQueryRelatedPersonTest;


public class JDBCNormQueryRelatedPersonTest extends AbstractQueryRelatedPersonTest {
    
    private Properties testProps;
    
    public JDBCNormQueryRelatedPersonTest() throws Exception {
