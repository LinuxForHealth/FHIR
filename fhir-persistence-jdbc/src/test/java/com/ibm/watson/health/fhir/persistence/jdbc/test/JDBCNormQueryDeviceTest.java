...
import com.ibm.watson.health.fhir.persistence.test.common.AbstractQueryDeviceTest;


public class JDBCNormQueryDeviceTest extends AbstractQueryDeviceTest {
    
    private Properties testProps;
    
    public JDBCNormQueryDeviceTest() throws Exception {
