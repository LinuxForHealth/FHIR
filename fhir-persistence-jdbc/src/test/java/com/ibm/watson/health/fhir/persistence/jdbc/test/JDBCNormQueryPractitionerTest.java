...
import com.ibm.watson.health.fhir.persistence.test.common.AbstractQueryPractitionerTest;


public class JDBCNormQueryPractitionerTest extends AbstractQueryPractitionerTest {
    
    private Properties testProps;
    
    public JDBCNormQueryPractitionerTest() throws Exception {
