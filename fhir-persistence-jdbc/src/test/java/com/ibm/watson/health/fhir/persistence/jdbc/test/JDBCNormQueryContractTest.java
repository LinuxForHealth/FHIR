...
import com.ibm.watson.health.fhir.persistence.test.common.AbstractQueryContractTest;


public class JDBCNormQueryContractTest extends AbstractQueryContractTest {
    
    private Properties testProps;
    
    public JDBCNormQueryContractTest() throws Exception {
