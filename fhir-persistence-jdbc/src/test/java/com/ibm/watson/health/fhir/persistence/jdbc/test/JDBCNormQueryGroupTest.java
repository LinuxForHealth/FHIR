...
import com.ibm.watson.health.fhir.persistence.test.common.AbstractQueryGroupTest;


public class JDBCNormQueryGroupTest extends AbstractQueryGroupTest {
    
    private Properties testProps;
    
    public JDBCNormQueryGroupTest() throws Exception {
