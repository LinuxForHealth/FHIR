...
import com.ibm.watson.health.fhir.persistence.test.common.AbstractSearchAllTest;


public class JDBCNormSearchAllTest extends AbstractSearchAllTest {
    
    private Properties testProps;
    
    public JDBCNormSearchAllTest() throws Exception {
