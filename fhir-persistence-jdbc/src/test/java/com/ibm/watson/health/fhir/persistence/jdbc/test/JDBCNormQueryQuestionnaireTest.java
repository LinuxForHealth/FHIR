...
import com.ibm.watson.health.fhir.persistence.test.common.AbstractQueryQuestionnaireTest;


public class JDBCNormQueryQuestionnaireTest extends AbstractQueryQuestionnaireTest {
    
    private Properties testProps;
    
    public JDBCNormQueryQuestionnaireTest() throws Exception {
