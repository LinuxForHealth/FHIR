...
import com.ibm.watson.health.fhir.persistence.test.common.AbstractQueryMedicationTest;


public class JDBCNormQueryMedicationTest extends AbstractQueryMedicationTest {
    
    private Properties testProps;
    
    public JDBCNormQueryMedicationTest() throws Exception {
