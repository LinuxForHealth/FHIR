...
import com.ibm.watson.health.fhir.persistence.test.common.AbstractQueryMultiResourceTest;


public class JDBCQueryMultiResourceTest extends AbstractQueryMultiResourceTest {
    
    private Properties testProps;
    
    public JDBCQueryMultiResourceTest() throws Exception {
