...
import com.ibm.watsonhealth.fhir.persistence.test.common.AbstractQueryEncounterTest;


public class JDBCQueryEncounterTest extends AbstractQueryEncounterTest {
    
    private Properties testProps;
    
    public JDBCQueryEncounterTest() throws Exception {
