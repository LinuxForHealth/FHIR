...
import com.ibm.watsonhealth.fhir.persistence.search.test.AbstractSearchNumberTest;
...
public class JDBCNormSearchNumberTest extends AbstractSearchNumberTest {
    ...
    /* (non-Javadoc)
     * @see com.ibm.watsonhealth.fhir.persistence.search.test.AbstractSearchNumberTest#testCreateBasicResource()
     */
    @Override
    @Test
    ...
    /* (non-Javadoc)
     * @see com.ibm.watsonhealth.fhir.persistence.search.test.AbstractSearchNumberTest#testSearchNumber_integer()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watsonhealth.fhir.persistence.search.test.AbstractSearchNumberTest#testSearchNumber_integer_ap()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watsonhealth.fhir.persistence.search.test.AbstractSearchNumberTest#testSearchNumber_integer_chained()
     */
    @Override
    @Test(dependsOnMethods = { "testCreateBasicResource" })
    ...
    /* (non-Javadoc)
     * @see com.ibm.watsonhealth.fhir.persistence.search.test.AbstractSearchNumberTest#testSearchNumber_integer_missing()
     */
    @Override
    @Test(dependsOnMethods = { "testCreateBasicResource" })
    ...
    /* (non-Javadoc)
     * @see com.ibm.watsonhealth.fhir.persistence.search.test.AbstractSearchNumberTest#testSearchNumber_decimal()
     */
    @Override
    @Test(dependsOnMethods = { "testCreateBasicResource" })
    ...
    /* (non-Javadoc)
     * @see com.ibm.watsonhealth.fhir.persistence.search.test.AbstractSearchNumberTest#testSearchNumber_decimal_invalidPrefix()
     */
    @Override
    @Test(dependsOnMethods = { "testCreateBasicResource" }, expectedExceptions = { FHIRSearchException.class })
    ...
    /* (non-Javadoc)
     * @see com.ibm.watsonhealth.fhir.persistence.search.test.AbstractSearchNumberTest#testSearchNumber_decimal_chained()
     */
    @Override
    @Test(dependsOnMethods = { "testCreateBasicResource" })
    ...
    /* (non-Javadoc)
     * @see com.ibm.watsonhealth.fhir.persistence.search.test.AbstractSearchNumberTest#testSearchNumber_decimal_missing()
     */
    @Override
    @Test(dependsOnMethods = { "testCreateBasicResource" })
