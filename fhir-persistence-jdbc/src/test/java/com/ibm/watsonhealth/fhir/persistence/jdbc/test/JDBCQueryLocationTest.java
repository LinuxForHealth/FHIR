...
import com.ibm.watsonhealth.fhir.persistence.test.common.AbstractQueryLocationTest;


public class JDBCQueryLocationTest extends AbstractQueryLocationTest {
    
    private Properties testProps;
    
    public JDBCQueryLocationTest() throws Exception {
