...
package com.ibm.watson.health.fhir.audit.logging.impl;
...
import com.ibm.watson.health.fhir.audit.cadf.model.CadfAttachment;
import com.ibm.watson.health.fhir.audit.cadf.model.CadfCredential;
import com.ibm.watson.health.fhir.audit.cadf.model.CadfEndpoint;
import com.ibm.watson.health.fhir.audit.cadf.model.CadfEvent;
import com.ibm.watson.health.fhir.audit.cadf.model.CadfGeolocation;
import com.ibm.watson.health.fhir.audit.cadf.model.CadfParser;
import com.ibm.watson.health.fhir.audit.cadf.model.CadfResource;
import com.ibm.watson.health.fhir.audit.kafka.Environment;
import com.ibm.watson.health.fhir.audit.kafka.EventStreamsCredentials;
import com.ibm.watson.health.fhir.audit.logging.api.AuditLogEventType;
import com.ibm.watson.health.fhir.audit.logging.api.AuditLogService;
import com.ibm.watson.health.fhir.audit.logging.beans.AuditLogEntry;
import com.ibm.watson.health.fhir.audit.logging.beans.Context;
...
public class WhcAuditCadfLogService implements AuditLogService {
     ...
     * 
     * @see
     * com.ibm.watson.health.fhir.audit.logging.api.AuditLogService#initialize(com.
     ...
     * 
     * @see
     * com.ibm.watson.health.fhir.audit.logging.api.AuditLogService#logEntry(com.ibm.
     ...
     * (non-Javadoc)
     * 
     * @see com.ibm.watson.health.fhir.audit.logging.api.AuditLogService#isEnabled()
     */
    @Override
