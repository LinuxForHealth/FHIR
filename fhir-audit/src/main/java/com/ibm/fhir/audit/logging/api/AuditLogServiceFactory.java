...
public class AuditLogServiceFactory {
    ...
    private static synchronized void createService() {
        ...
        if (serviceInstance == null) {
            ...
            serviceClassName = FHIRConfigHelper.getStringProperty(tenantId, FHIRConfiguration.PROPERTY_AUDIT_SERVICE_CLASS_NAME, null);
                ...
                try {
                    ...
                    if (AuditLogService.class.isAssignableFrom(serviceClass)) {
                        try {
                            ...
                            auditLogProperties = FHIRConfigHelper.getPropertyGroup(tenantId, FHIRConfiguration.PROPERTY_AUDIT_SERVICE_PROPERTIES);
