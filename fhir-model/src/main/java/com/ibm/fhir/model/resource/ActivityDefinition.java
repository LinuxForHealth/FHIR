...
public class ActivityDefinition extends DomainResource {
    ...
    private ActivityDefinition(Builder builder) {
        ...
        specimenRequirement = ValidationSupport.checkAndFinalizeList(builder.specimenRequirement, "specimenRequirement", Reference.class);
        observationRequirement = ValidationSupport.checkAndFinalizeList(builder.observationRequirement, "observationRequirement", Reference.class);
        observationResultRequirement = ValidationSupport.checkAndFinalizeList(builder.observationResultRequirement, "observationResultRequirement", Reference.class);
