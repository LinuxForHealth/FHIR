...
public class CarePlan extends DomainResource {
    ...
    @Binding(
        ...
        valueSet = "http://hl7.org/fhir/ValueSet/care-plan-intent|4.1.0"
    )
    @Required
    ...
    public static class Activity extends BackboneElement {
        ...
        public static class Detail extends BackboneElement {
            @Binding(
                ...
                valueSet = "http://hl7.org/fhir/ValueSet/care-plan-activity-kind|4.1.0"
            )
            ...
            @Binding(
                ...
                valueSet = "http://hl7.org/fhir/ValueSet/care-plan-activity-status|4.1.0"
            )
            @Required
