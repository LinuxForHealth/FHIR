...
public class Bundle extends Resource {
    ...
    @Binding(
        ...
        valueSet = "http://hl7.org/fhir/ValueSet/bundle-type|4.1.0"
    )
    @Required
    ...
    public static class Entry extends BackboneElement {
        ...
        public static class Search extends BackboneElement {
            ...
            @Binding(
                ...
                valueSet = "http://hl7.org/fhir/ValueSet/search-entry-mode|4.1.0"
            )
        ...
        public static class Request extends BackboneElement {
            ...
            @Binding(
                ...
                valueSet = "http://hl7.org/fhir/ValueSet/http-verb|4.1.0"
            )
            @Required
