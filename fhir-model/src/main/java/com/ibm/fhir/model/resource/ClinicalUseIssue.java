...
import com.ibm.fhir.model.type.code.ClinicalUseIssueType;
...
@Constraint(
    ...
    level = "Rule",
    location = "(base)",
    description = "Indication, Contraindication, Interaction and UndesirableEffect cannot be used in the same instance (note that the expressions are not yet correct)",
    expression = "(ClinicalUseIssue.indication.count() + ClinicalUseIssue.contraIndication.count() + ClinicalUseIssue.interaction.count() + ClinicalUseIssue.undesirableEffect.count())  < 2",
    source = "http://hl7.org/fhir/StructureDefinition/ClinicalUseIssue"
)
...
public class ClinicalUseIssue extends DomainResource {
    ...
    private ClinicalUseIssue(Builder builder) {
        super(builder);
     ...
     * 
     * @return
     *     An immutable object of type {@link ClinicalUseIssueType} that is non-null.
     */
    ...
    /**
     * General description of an effect (particularly for a general warning, rather than any of the more specific types such 
     * as indication) for when a distinct coded or textual description is not appropriate using Indication.
     * diseaseSymptomProcedure.text, Contraindication.diseaseSymptomProcedure.text etc. For example "May affect ability to 
     * drive".
     * 
     * @return
    ...
    public boolean equals(Object obj) {
        ...
        ClinicalUseIssue other = (ClinicalUseIssue) obj;
    ...
    public static class Builder extends DomainResource.Builder {
        ...
        private ClinicalUseIssueType type;
         ...
         *     A reference to this Builder instance
         */
        public Builder type(ClinicalUseIssueType type) {
            this.type = type;
            return this;
        }
        ...
        /**
         * Build the {@link ClinicalUseIssue}
         * 
         * <p>Required elements:
         * <ul>
         * <li>type</li>
         ...
         * 
         * @return
         *     An immutable object of type {@link ClinicalUseIssue}
         * @throws IllegalStateException
         *     if the current state cannot be built into a valid ClinicalUseIssue per the base specification
         */
        @Override
        public ClinicalUseIssue build() {
            ClinicalUseIssue clinicalUseIssue = new ClinicalUseIssue(this);
            if (validating) {
                validate(clinicalUseIssue);
            }
            return clinicalUseIssue;
        }

        protected void validate(ClinicalUseIssue clinicalUseIssue) {
            super.validate(clinicalUseIssue);
            ValidationSupport.checkList(clinicalUseIssue.identifier, "identifier", Identifier.class);
            ValidationSupport.requireNonNull(clinicalUseIssue.type, "type");
            ValidationSupport.checkList(clinicalUseIssue.category, "category", CodeableConcept.class);
            ValidationSupport.checkList(clinicalUseIssue.subject, "subject", Reference.class);
            ValidationSupport.checkList(clinicalUseIssue.population, "population", Population.class);
            ValidationSupport.checkReferenceType(clinicalUseIssue.subject, "subject", "MedicinalProductDefinition", "Medication", "ActivityDefinition", "PlanDefinition", "Device", "DeviceDefinition", "Substance");
        }

        protected Builder from(ClinicalUseIssue clinicalUseIssue) {
            super.from(clinicalUseIssue);
            identifier.addAll(clinicalUseIssue.identifier);
            type = clinicalUseIssue.type;
            category.addAll(clinicalUseIssue.category);
            subject.addAll(clinicalUseIssue.subject);
            status = clinicalUseIssue.status;
            description = clinicalUseIssue.description;
            contraindication = clinicalUseIssue.contraindication;
            indication = clinicalUseIssue.indication;
            interaction = clinicalUseIssue.interaction;
            population.addAll(clinicalUseIssue.population);
            undesirableEffect = clinicalUseIssue.undesirableEffect;
            return this;
        }
    }
    ...
    public static class Contraindication extends BackboneElement {
        ...
        @Summary
        @ReferenceTarget({ "ClinicalUseIssue" })
        ...
        public static class Builder extends BackboneElement.Builder {
            ...
            protected void validate(Contraindication contraindication) {
                ...
                ValidationSupport.checkReferenceType(contraindication.indication, "indication", "ClinicalUseIssue");
    ...
    public static class Indication extends BackboneElement {
        ...
        @Summary
        private final List<ClinicalUseIssue.Contraindication.OtherTherapy> otherTherapy;
         ...
         *     An unmodifiable list containing immutable objects of type {@link OtherTherapy} that may be empty.
         */
        public List<ClinicalUseIssue.Contraindication.OtherTherapy> getOtherTherapy() {
            return otherTherapy;
        }
        ...
        public void accept(java.lang.String elementName, int elementIndex, Visitor visitor) {
            if (visitor.preVisit(this)) {
                ...
                if (visitor.visit(elementName, elementIndex, this)) {
                    ...
                    accept(otherTherapy, "otherTherapy", visitor, ClinicalUseIssue.Contraindication.OtherTherapy.class);
                }
                visitor.visitEnd(elementName, elementIndex, this);
                visitor.postVisit(this);
            }
        ...
        public static class Builder extends BackboneElement.Builder {
            ...
            private List<ClinicalUseIssue.Contraindication.OtherTherapy> otherTherapy = new ArrayList<>();
             ...
             *     A reference to this Builder instance
             */
            public Builder otherTherapy(ClinicalUseIssue.Contraindication.OtherTherapy... otherTherapy) {
                for (ClinicalUseIssue.Contraindication.OtherTherapy value : otherTherapy) {
                    this.otherTherapy.add(value);
                }
                return this;
            }
             ...
             *     If the passed collection is null
             */
            public Builder otherTherapy(Collection<ClinicalUseIssue.Contraindication.OtherTherapy> otherTherapy) {
                this.otherTherapy = new ArrayList<>(otherTherapy);
                return this;
            }
            ...
            protected void validate(Indication indication) {
                ...
                ValidationSupport.checkList(indication.otherTherapy, "otherTherapy", ClinicalUseIssue.Contraindication.OtherTherapy.class);
                ValidationSupport.checkReferenceType(indication.undesirableEffect, "undesirableEffect", "ClinicalUseIssue");
