...
public class StructureMap extends DomainResource {
    ...
    public static class Structure extends BackboneElement {
        ...
        @Binding(
            ...
            valueSet = "http://hl7.org/fhir/ValueSet/map-model-mode|4.1.0"
        )
        @Required
    ...
    public static class Group extends BackboneElement {
        ...
        @Binding(
            ...
            valueSet = "http://hl7.org/fhir/ValueSet/map-group-type-mode|4.1.0"
        )
        @Required
        ...
        public static class Input extends BackboneElement {
            ...
            @Binding(
                ...
                valueSet = "http://hl7.org/fhir/ValueSet/map-input-mode|4.1.0"
            )
            @Required
        ...
        public static class Rule extends BackboneElement {
            ...
            public static class Source extends BackboneElement {
                ...
                @Binding(
                    ...
                    valueSet = "http://hl7.org/fhir/ValueSet/map-source-list-mode|4.1.0"
                )
            ...
            public static class Target extends BackboneElement {
                ...
                @Binding(
                    ...
                    valueSet = "http://hl7.org/fhir/ValueSet/map-context-type|4.1.0"
                )
                ...
                @Binding(
                    ...
                    valueSet = "http://hl7.org/fhir/ValueSet/map-target-list-mode|4.1.0"
                )
                ...
                @Binding(
                    ...
                    valueSet = "http://hl7.org/fhir/ValueSet/map-transform|4.1.0"
                )
