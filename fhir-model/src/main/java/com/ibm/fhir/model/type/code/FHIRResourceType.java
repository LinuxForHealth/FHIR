...
public class FHIRResourceType extends Code {
     ...
     */
    public static final FHIRResourceType ADMINISTRABLE_PRODUCT_DEFINITION = FHIRResourceType.builder().value(Value.ADMINISTRABLE_PRODUCT_DEFINITION).build();
     ...
     */
    public static final FHIRResourceType CITATION = FHIRResourceType.builder().value(Value.CITATION).build();
     ...
     */
    public static final FHIRResourceType EVIDENCE_REPORT = FHIRResourceType.builder().value(Value.EVIDENCE_REPORT).build();
     ...
     */
    public static final FHIRResourceType INGREDIENT = FHIRResourceType.builder().value(Value.INGREDIENT).build();
     ...
     */
    public static final FHIRResourceType MANUFACTURED_ITEM_DEFINITION = FHIRResourceType.builder().value(Value.MANUFACTURED_ITEM_DEFINITION).build();
     ...
     * drug catalogs).
     */
    public static final FHIRResourceType MEDICINAL_PRODUCT_DEFINITION = FHIRResourceType.builder().value(Value.MEDICINAL_PRODUCT_DEFINITION).build();
     ...
     */
    public static final FHIRResourceType NUTRITION_PRODUCT = FHIRResourceType.builder().value(Value.NUTRITION_PRODUCT).build();
     ...
     * Product.
     */
    public static final FHIRResourceType REGULATED_AUTHORIZATION = FHIRResourceType.builder().value(Value.REGULATED_AUTHORIZATION).build();
     ...
     */
    public static final FHIRResourceType SUBSCRIPTION_STATUS = FHIRResourceType.builder().value(Value.SUBSCRIPTION_STATUS).build();
     ...
     */
    public static final FHIRResourceType SUBSTANCE_DEFINITION = FHIRResourceType.builder().value(Value.SUBSTANCE_DEFINITION).build();
    ...
    /**
     * Get the value of this FHIRResourceType as an enum constant.
     */
    ...
    public static class Builder extends Code.Builder {
         ...
         * 
         * @param value
         *     An enum constant for FHIRResourceType
         * 
         * @return
    ...
    public enum Value {
        ...
        /**
         * Factory method for creating FHIRResourceType.Value values from a passed string value.
         * 
         * @param value
         *     A string that matches one of the allowed code values
         * @return
         *     The corresponding FHIRResourceType.Value or null if a null value was passed
         * @throws IllegalArgumentException
