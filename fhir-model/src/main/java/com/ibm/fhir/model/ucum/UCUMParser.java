...
public class UCUMParser extends Parser {
    ...
    public static final int T__0 = 1, T__1 = 2, T__2 = 3, T__3 = 4, T__4 = 5, T__5 = 6, T__6 = 7, T__7 = 8, T__8 = 9,
            ...
            DIGIT_SYMBOL = 15;
    public static final int RULE_mainTerm = 0, RULE_term = 1, RULE_component = 2, RULE_annotatable = 3,
    ...
    public static class MainTermContext extends ParserRuleContext {
        ...
        public TerminalNode EOF() {
            return getToken(UCUMParser.EOF, 0);
        }
            ...
            enterOuterAlt(_localctx, 1);
            {
                ...
                do {
                    ...
                    _la = _input.LA(1);
                        ...
                        && ((1L << _la) & ((1L << T__0) | (1L << T__1) | (1L << T__2) | (1L << T__3) | (1L << T__6) | (1L << T__7) | (1L << T__8) | (1L << T__9)
                                | (1L << T__10) | (1L << T__11) | (1L << T__12) | (1L << NON_DIGIT_TERMINAL_UNIT_SYMBOL) | (1L << DIGIT_SYMBOL))) != 0));
                setState(92);
                match(T__5);
            }
        } catch (RecognitionException re) {
    ...
    public static class SquareBracketsSymbolsContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_squareBracketsSymbols;
        }
    }
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                do {
                    ...
                    _errHandler.sync(this);
                    _la = _input.LA(1);
                } while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__0) | (1L << T__1) | (1L << T__2) | (1L << T__3) | (1L << T__4) | (1L << T__5)
                        | (1L << T__9) | (1L << T__10) | (1L << T__11) | (1L << T__12) | (1L << NON_DIGIT_TERMINAL_UNIT_SYMBOL) | (1L << DIGIT_SYMBOL))) != 0));
                setState(100);
                match(T__7);
            }
        } catch (RecognitionException re) {
    ...
    public static class WithinCbOrSbSymbolContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_withinCbOrSbSymbol;
        }
    }
    ...
    public static class TerminalUnitSymbolContext extends ParserRuleContext {
        ...
        public TerminalNode NON_DIGIT_TERMINAL_UNIT_SYMBOL() {
            return getToken(UCUMParser.NON_DIGIT_TERMINAL_UNIT_SYMBOL, 0);
        }

        public TerminalNode DIGIT_SYMBOL() {
            return getToken(UCUMParser.DIGIT_SYMBOL, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_terminalUnitSymbol;
        }
    }
    ...
    public static class DigitSymbolsContext extends ParserRuleContext {
        ...
        public List<TerminalNode> DIGIT_SYMBOL() {
            return getTokens(UCUMParser.DIGIT_SYMBOL);
        }
