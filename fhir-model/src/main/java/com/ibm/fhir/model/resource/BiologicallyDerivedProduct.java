...
public class BiologicallyDerivedProduct extends DomainResource {
    ...
    @Binding(
        ...
        valueSet = "http://hl7.org/fhir/ValueSet/product-category|4.1.0"
    )
    ...
    @Binding(
        ...
        valueSet = "http://hl7.org/fhir/ValueSet/product-status|4.1.0"
    )
    ...
    public static class Storage extends BackboneElement {
        ...
        @Binding(
            ...
            valueSet = "http://hl7.org/fhir/ValueSet/product-storage-scale|4.1.0"
        )
