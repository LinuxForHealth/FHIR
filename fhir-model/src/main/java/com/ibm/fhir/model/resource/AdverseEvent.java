...
public class AdverseEvent extends DomainResource {
    ...
    @Binding(
        ...
        valueSet = "http://hl7.org/fhir/ValueSet/adverse-event-actuality|4.1.0"
    )
    @Required
    ...
    @Binding(
        ...
        valueSet = "http://hl7.org/fhir/ValueSet/adverse-event-severity|4.1.0"
    )
    ...
    @Binding(
        ...
        valueSet = "http://hl7.org/fhir/ValueSet/adverse-event-outcome|4.1.0"
    )
