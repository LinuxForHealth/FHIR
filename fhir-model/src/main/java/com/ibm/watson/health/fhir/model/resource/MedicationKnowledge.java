...
import com.ibm.watson.health.fhir.model.type.MedicationKnowledgeStatus;
...
public class MedicationKnowledge extends DomainResource {
    ...
    public static class AdministrationGuidelines extends BackboneElement {
        ...
        public static class Dosage extends BackboneElement {
            ...
            private final CodeableConcept type;
            @Required
            private final List<com.ibm.watson.health.fhir.model.type.Dosage> dosage;
             ...
             *     An unmodifiable list containing immutable objects of type {@link Dosage}.
             */
            public List<com.ibm.watson.health.fhir.model.type.Dosage> getDosage() {
                return dosage;
            }
            ...
            public void accept(java.lang.String elementName, int elementIndex, Visitor visitor) {
                if (visitor.preVisit(this)) {
                    ...
                    if (visitor.visit(elementName, elementIndex, this)) {
                        ...
                        accept(modifierExtension, "modifierExtension", visitor, Extension.class);
                        accept(type, "type", visitor);
                        accept(dosage, "dosage", visitor, com.ibm.watson.health.fhir.model.type.Dosage.class);
                    }
                    visitor.visitEnd(elementName, elementIndex, this);
                    visitor.postVisit(this);
                }
            ...
            public static class Builder extends BackboneElement.Builder {
                private CodeableConcept type;
                private List<com.ibm.watson.health.fhir.model.type.Dosage> dosage = new ArrayList<>();
                 ...
                 *     A reference to this Builder instance
                 */
                public Builder dosage(com.ibm.watson.health.fhir.model.type.Dosage... dosage) {
                    for (com.ibm.watson.health.fhir.model.type.Dosage value : dosage) {
                        this.dosage.add(value);
                    }
                    return this;
                }
                 ...
                 *     A reference to this Builder instance
                 */
                public Builder dosage(Collection<com.ibm.watson.health.fhir.model.type.Dosage> dosage) {
                    this.dosage = new ArrayList<>(dosage);
                    return this;
                }
