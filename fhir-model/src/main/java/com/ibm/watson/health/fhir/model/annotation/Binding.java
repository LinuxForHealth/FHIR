...
package com.ibm.watson.health.fhir.model.annotation;
...
public @interface Binding {
     ...
     */
    BindingStrength.ValueSet strength();
    ...
    /**
     * A reference to an extensible value set specified in a parent profie in order to allow a conformance checking tool
