...
public class ValidationSupportValueSetTest {
    ...
    public void testCheckValueSetBindingStringValid1() {
        ValidationSupport.checkValueSetBinding((com.ibm.fhir.model.type.String)null, "elementName", "valueSetUrl", null, "code1");
    }

    @Test
    public void testCheckValueSetBindingStringValid2() {
        ValidationSupport.checkValueSetBinding(com.ibm.fhir.model.type.String.of("code1"), "elementName", "valueSetUrl", null, "code1");
    }

    @Test
    public void testCheckValueSetBindingStringValid3() {
        ValidationSupport.checkValueSetBinding(com.ibm.fhir.model.type.String.builder().extension(Extension.builder().url("http://hl7.org/fhir/StructureDefinition/data-absent-reason").value(Code.of("unknown")).build()).build(), "elementName", "valueSetUrl", null, "code1");
    }

    @Test
    public void testCheckValueSetBindingStringNotValid1() {
        try {
            ValidationSupport.checkValueSetBinding(com.ibm.fhir.model.type.String.of("code1"), "elementName", "valueSetUrl", null);
            fail();
        } catch (IllegalStateException e) {}
    }
    ...
    public void testCheckValueSetBindingStringNotValid2() {
        try {
            ValidationSupport.checkValueSetBinding(com.ibm.fhir.model.type.String.of("code1"), "elementName", "valueSetUrl", null, "code2");
            fail();
        } catch (IllegalStateException e) {}
    }
    ...
    public void testCheckValueSetBindingStringsNotValid() {
        try {
            ValidationSupport.checkValueSetBinding(Arrays.asList(com.ibm.fhir.model.type.String.of("code1"), com.ibm.fhir.model.type.String.of("code2")), "elementName", "valueSetUrl", null, "code1", "code3");
            fail();
        } catch (IllegalStateException e) {}
    }
