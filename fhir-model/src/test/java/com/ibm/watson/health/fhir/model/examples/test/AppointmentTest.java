...
import com.ibm.watson.health.fhir.model.type.ParticipantRequired;
import com.ibm.watson.health.fhir.model.type.ParticipationStatus;
...
public class AppointmentTest {
    ...
    public Coding getCoding(String system, String version, String code, String display,
        ...
        if (userSelected != null) {
            coding.userSelected(com.ibm.watson.health.fhir.model.type.Boolean.builder().value(userSelected).build());
        }
