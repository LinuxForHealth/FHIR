...
import org.linuxforhealth.fhir.persistence.params.api.ParamSchemaConstants;
...
/**
 * Oracle variant of the plain schema param value processor which is needed because Oracle
 * needs slightly different syntax for some SQL and DML statements
 */
public class PlainOracleParamValueProcessor extends PlainParamValueProcessor {
    private static final Logger logger = Logger.getLogger(PlainOracleParamValueProcessor.class.getName());
     ...
     * @param cache
     */
    public PlainOracleParamValueProcessor(Connection connection, String schemaName, IParameterIdentityCache cache) {
        super(new OracleTranslator(), connection, schemaName, cache);
    }
