...
import org.linuxforhealth.fhir.path.FHIRPathNumberValue;
...
public final class FHIRPathUtil {
     ...
     */
    public static org.linuxforhealth.fhir.model.type.String getVersion(FHIRPathTree tree, FHIRPathElementNode elementNode) {
        if (tree != null) {
     ...
     */
    public static org.linuxforhealth.fhir.model.type.String getDisplay(FHIRPathTree tree, FHIRPathElementNode elementNode) {
        if (tree != null) {
