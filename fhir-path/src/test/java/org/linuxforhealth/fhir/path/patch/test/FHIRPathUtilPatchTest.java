 ...
 */
package org.linuxforhealth.fhir.path.patch.test;
...
public class FHIRPathUtilPatchTest {
    ...
    private void testRemoveElementId() throws FHIRPathException, FHIRPatchException {
        Patient modifiedPatient = FHIRPathUtil.add(patient, "Patient", "active", org.linuxforhealth.fhir.model.type.Boolean.builder()
                .id("elementId")
                .value(true)
                .build());
    ...
    private void testRemoveValue_invalid() throws FHIRPathException, FHIRPatchException {
        Patient modifiedPatient = FHIRPathUtil.add(patient, "Patient", "active", org.linuxforhealth.fhir.model.type.Boolean.TRUE);
