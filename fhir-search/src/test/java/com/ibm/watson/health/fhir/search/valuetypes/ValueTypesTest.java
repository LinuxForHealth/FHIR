...
import com.ibm.watson.health.fhir.model.resource.Account;
import com.ibm.watson.health.fhir.model.resource.ActivityDefinition;
import com.ibm.watson.health.fhir.model.resource.AdverseEvent;
...
import com.ibm.watson.health.fhir.model.resource.ClaimResponse;
import com.ibm.watson.health.fhir.model.resource.MolecularSequence;
...
public class ValueTypesTest extends BaseSearchTest {
    ...
    public void testGetValueTypes2() throws Exception {
        ...
        assertEquals(valueTypes.size(), 1);
        assertTrue(valueTypes.contains(com.ibm.watson.health.fhir.model.type.Id.class));
    }
