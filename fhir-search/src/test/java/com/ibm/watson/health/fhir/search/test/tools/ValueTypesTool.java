...
public class ValueTypesTool {
    ...
    public static String discoverType(String expression) {
        ...
        Class<?> newClass = processClass("com.ibm.watson.health.fhir.model.resource", components[0]);
        if (newClass == null) {
            newClass = processClass("com.ibm.watson.health.fhir.model.type", components[0]);
        }
