...
package com.ibm.watson.health.fhir.search.compartment;
...
import com.ibm.watson.health.fhir.search.compartment.CompartmentCache;
...
public class CompartmentCacheTest extends BaseSearchTest {
    ...
    public void testGetParametersByResourceTypeInCompartmentUnmodifiable() {
        ...
        List<com.ibm.watson.health.fhir.model.type.String> params = new ArrayList<>();
        params.add(com.ibm.watson.health.fhir.model.type.String.string("Ketchup"));
