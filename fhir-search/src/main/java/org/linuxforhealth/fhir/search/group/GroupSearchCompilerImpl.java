...
import org.linuxforhealth.fhir.search.group.characteristic.AdministrativeGenderCharacteristicProcessor;
import org.linuxforhealth.fhir.search.group.characteristic.CharacteristicProcessor;
import org.linuxforhealth.fhir.search.group.characteristic.NoOpCharacteristicProcessor;
import org.linuxforhealth.fhir.search.group.characteristic.PatientAgeCharacteristicProcessor;
import org.linuxforhealth.fhir.search.group.characteristic.PregnancyStatusCharacteristicProcessor;
    ...
    public MultivaluedMap<String, String> groupToSearch(Group group, String target) throws GroupSearchCompilerException {
        ...
        try {
            ...
            for (FHIRPathNode node : tmpResults) {
                ...
                } else if (characteristic.getValue().is(org.linuxforhealth.fhir.model.type.Boolean.class)) {
