...
| [$versions](https://hl7.org/fhir/capabilitystatement-operation-versions.html) | Returns the list of supported FHIR versions | Returning output in non-FHIR formats is not supported |
