...
- DaVinci Payer Data Exchange (PDEX) Implementation Guide (v0.1.18: CI Build) [http://build.fhir.org/ig/HL7/davinci-epdx/)
...
- DaVinci Payer Data Exchange (PDex) US Drug Formulary STU 1 [http://hl7.org/fhir/us/davinci-drug-formulary/STU1/](http://hl7.org/fhir/us/davinci-drug-formulary/STU1/)
