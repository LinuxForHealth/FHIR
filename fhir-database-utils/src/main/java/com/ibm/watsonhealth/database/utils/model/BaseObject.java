...
public abstract class BaseObject implements IDatabaseObject {
    ...
    /* (non-Javadoc)
     * @see com.ibm.watsonhealth.database.utils.model.IDatabaseObject#collect(com.ibm.watsonhealth.task.api.ITaskCollector, com.ibm.watsonhealth.database.utils.api.IDatabaseAdapter)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watsonhealth.database.utils.model.IDatabaseObject#getTags()
     */
    @Override
