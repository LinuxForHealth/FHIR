...
import com.ibm.watsonhealth.database.utils.api.ConnectionDetails;
import com.ibm.watsonhealth.database.utils.api.ConnectionException;
...
import com.ibm.watsonhealth.database.utils.api.LockException;
...
public class Db2Translator implements IDatabaseTranslator {
    ...
    /* (non-Javadoc)
     * @see com.ibm.watsonhealth.database.utils.api.IDatabaseTranslator#getDriverClassName()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watsonhealth.database.utils.api.IDatabaseTranslator#getUrl(java.util.Properties)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watsonhealth.database.utils.api.IDatabaseTranslator#clobSupportsInline()
     */
    @Override
