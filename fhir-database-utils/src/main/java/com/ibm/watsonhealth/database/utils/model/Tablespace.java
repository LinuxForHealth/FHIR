...
public class Tablespace extends DatabaseObject {    
    ...
    /* (non-Javadoc)
     * @see com.ibm.watsonhealth.database.utils.model.IDatabaseObject#collect(com.ibm.watsonhealth.task.api.ITaskCollector, com.ibm.watsonhealth.database.utils.api.IDatabaseAdapter, com.ibm.watsonhealth.database.utils.api.ITransactionProvider)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watsonhealth.database.utils.model.IDatabaseObject#addDependencies(java.util.Collection)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watsonhealth.database.utils.model.IDatabaseObject#fetchDependenciesTo(java.util.Collection)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watsonhealth.database.utils.model.IDatabaseObject#grant(com.ibm.watsonhealth.database.utils.api.IDatabaseAdapter, java.lang.String, java.lang.String)
     */
    @Override
