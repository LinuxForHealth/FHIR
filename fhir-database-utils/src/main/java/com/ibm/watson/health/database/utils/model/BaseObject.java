...
public abstract class BaseObject implements IDatabaseObject {
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.database.utils.model.IDatabaseObject#collect(com.ibm.watson.health.task.api.ITaskCollector, com.ibm.watson.health.database.utils.api.IDatabaseAdapter)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.database.utils.model.IDatabaseObject#applyTx(com.ibm.watson.health.database.utils.api.IDatabaseAdapter)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.database.utils.model.IDatabaseObject#getTags()
     */
    @Override
