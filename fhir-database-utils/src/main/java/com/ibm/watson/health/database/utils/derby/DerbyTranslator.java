...
import com.ibm.watson.health.database.utils.api.ConnectionDetails;
import com.ibm.watson.health.database.utils.api.ConnectionException;
...
import com.ibm.watson.health.database.utils.api.LockException;
...
public class DerbyTranslator implements IDatabaseTranslator {
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.database.utils.api.IDatabaseTranslator#getDriverClassName()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.database.utils.api.IDatabaseTranslator#getUrl(java.util.Properties)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.database.utils.api.IDatabaseTranslator#clobSupportsInline()
     */
    @Override
