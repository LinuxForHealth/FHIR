...
public class Tablespace extends DatabaseObject {    
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.database.utils.model.IDatabaseObject#collect(com.ibm.watson.health.task.api.ITaskCollector, com.ibm.watson.health.database.utils.api.IDatabaseAdapter, com.ibm.watson.health.database.utils.api.ITransactionProvider)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.database.utils.model.IDatabaseObject#addDependencies(java.util.Collection)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.database.utils.model.IDatabaseObject#fetchDependenciesTo(java.util.Collection)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.database.utils.model.IDatabaseObject#grant(com.ibm.watson.health.database.utils.api.IDatabaseAdapter, java.lang.String, java.lang.String)
     */
    @Override
