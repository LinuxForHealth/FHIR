...
/**
 * Checks to see if the named table exists
 */
public class OracleDoesTableExist implements IDatabaseSupplier<Boolean> {
     ...
     * @param tableName
     */
    public OracleDoesTableExist(String schemaName, String tableName) {
