...
The image wraps the LinuxForHealth FHIR Server Bucket Tool which wraps the module - `fhir-bucket`.

************
# **License**

The LinuxForHealth FHIR Server - Bucket Tool is licensed under the Apache 2.0 license. Full license text is available at [LICENSE](https://github.com/LinuxForHealth/FHIR/blob/main/LICENSE).
