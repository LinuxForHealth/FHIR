...
java -jar volumes/schema/fhir-persistence-schema-4.0.1-SNAPSHOT-cli.jar \
...
tenantKey=$(java -jar volumes/schema/fhir-persistence-schema-4.0.1-SNAPSHOT-cli.jar \
