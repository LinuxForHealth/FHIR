...
public class FHIRResponseImpl implements FHIRResponse {
    ...
    /* (non-Javadoc)
     * @see com.ibm.fhir.client.FHIRResponse#getStatusCode()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.fhir.client.FHIRResponse#getLocationURI()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.fhir.client.FHIRResponse#getLocation()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.fhir.client.FHIRResponse#getLastModified()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.fhir.client.FHIRResponse#getETag()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.fhir.client.FHIRResponse#getResource(java.lang.Class)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.fhir.client.FHIRResponse#getResponse()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.fhir.client.FHIRResponse#parseLocation()
     */
    @Override
