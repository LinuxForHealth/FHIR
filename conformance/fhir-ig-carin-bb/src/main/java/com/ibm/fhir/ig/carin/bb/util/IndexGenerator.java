...
package com.ibm.fhir.ig.carin.bb.util;
...
public class IndexGenerator {
    public static void main(String[] args) throws Exception {
        ...
        File dir = new File("src/main/resources/hl7/fhir/us/carin-bb/package/");
        ...
        try (OutputStream out = new FileOutputStream("src/main/resources/hl7/fhir/us/carin-bb/package/.index.json")) {
            index.store(out);
        }
    }
}
