...
public class ReplicationInfoUnmarshaller implements Unmarshaller<ReplicationInfo>{
	@Override
	public ReplicationInfo unmarshall(String json) throws FHIRException {
		final Gson gson = new GsonBuilder()
				   .setDateFormat(ISO_8601_GMT_DATE_FORMAT).create();
		
		if(json == null || json.isEmpty()) {
			throw new FHIRException("Error while unmarshalling ReplicationInfo. Obj cannot be null.");
		}
