    ...
    private static Parameter parseParameter(String typeName, String paramName, String value) throws FHIROperationException {
        ...
        try {
            if ("boolean".equals(typeName)) {
                parameterBuilder.value(org.linuxforhealth.fhir.model.type.Boolean.of(value));
            } else if ("integer".equals(typeName)) {
                parameterBuilder.value(org.linuxforhealth.fhir.model.type.Integer.of(value));
            } else if ("string".equals(typeName)) {
                parameterBuilder.value(org.linuxforhealth.fhir.model.type.String.of(value));
            } else if ("decimal".equals(typeName)) {
                parameterBuilder.value(org.linuxforhealth.fhir.model.type.Decimal.of(value));
