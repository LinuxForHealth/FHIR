...
package com.ibm.watson.health.fhir.operation.document;
    ...
    protected Parameters doInvoke(FHIROperationContext operationContext, Class<? extends Resource> resourceType, String logicalId, String versionId, Parameters parameters,
        ...
        try {
            ...
            if (persistParameter != null) {
                com.ibm.watson.health.fhir.model.type.Boolean persistParameterValue = persistParameter.getValue().as(com.ibm.watson.health.fhir.model.type.Boolean.class); //getValueBoolean();
