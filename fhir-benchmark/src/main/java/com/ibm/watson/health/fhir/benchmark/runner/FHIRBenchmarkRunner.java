...
package com.ibm.watson.health.fhir.benchmark.runner;
...
public class FHIRBenchmarkRunner {
    public static final String PROPERTY_EXAMPLE_NAME = "com.ibm.watson.health.fhir.benchmark.exampleName";
    public static final String PROPERTY_EXPRESSION = "com.ibm.watson.health.fhir.benchmark.expression";
