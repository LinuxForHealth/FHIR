...
public class FHIRRestInteractionVisitorPersist extends FHIRRestInteractionVisitorBase {
    ...
    public FHIRRestOperationResponse doSearch(int entryIndex, String requestDescription, FHIRUrlParser requestURL,
        ...
        doInteraction(entryIndex, requestDescription, initialTime, localStartTime, () -> {
    ...
    public FHIRRestOperationResponse doCreate(int entryIndex, FHIRPersistenceEvent event, List<Issue> warnings,
        ...
        doInteraction(entryIndex, requestDescription, initialTime, localStartTime, () -> {
            ...
            return buildResponseBundleEntry(ior, validationOutcome, requestDescription);
        });
    ...
    public FHIRRestOperationResponse validationResponse(int entryIndex, Entry validationResponseEntry,
        ...
        setEntryComplete(entryIndex, validationResponseEntry, requestDescription, initialTime, initialTime);
        return null;
    }

    @Override
    public FHIRRestOperationResponse issue(int entryIndex, String requestDescription, long initialTime, Status status,
            Entry responseEntry) throws Exception {
        setEntryComplete(entryIndex, responseEntry, requestDescription, initialTime, initialTime);
        return null;
    }
     ...
     * @throws Exception
     */
    private void doInteraction(int entryIndex, String requestDescription, long initialTime, long localStartTime, Callable<Entry> v)
            throws Exception {
