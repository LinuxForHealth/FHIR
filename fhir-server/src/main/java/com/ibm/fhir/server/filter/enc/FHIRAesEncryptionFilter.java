...
import static com.ibm.fhir.config.FHIRConfiguration.PROPERTY_ENCRYPTION;
 ...
 * like the following:
 * <jndiEntry id="encryptionConfig" jndiName="com.ibm.fhir.encryption.aes.config" value="config/aesKey.txt"/>
 * 
 * @author padams
 */
//@formatter:on
public class FHIRAesEncryptionFilter implements Filter {
    ...
    // <jndiEntry id="encryptionEnabled" jndiName="com.ibm.fhir.encryption.enabled" value="true"/>
    // <jndiEntry id="encryptionKeystoreLocation" jndiName="com.ibm.fhir.encryption.keystore.location"
    // value="resources/security/fhirkeys.jceks"/>
    // <jndiEntry id="encryptionKeystorePassword" jndiName="com.ibm.fhir.encryption.keystore.password"
    // <jndiEntry id="encryptionKeystorePassword" jndiName="com.ibm.fhir.encryption.key.password"
