...
public class FHIRRestServletFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        try {
            ...
            if (request instanceof HttpServletRequest && response instanceof HttpServletResponse) {
                ...
                switch (format) {
                case XML:
                    httpResponse.setContentType(com.ibm.watson.health.fhir.core.FHIRMediaType.APPLICATION_FHIR_XML);
                    break;
                case JSON:
                default:
                    httpResponse.setContentType(com.ibm.watson.health.fhir.core.FHIRMediaType.APPLICATION_FHIR_JSON);
                    break;
                }
    ...
    private Format chooseResponseFormat(String acceptableContentTypes) {
        if (acceptableContentTypes.contains(com.ibm.watson.health.fhir.core.FHIRMediaType.APPLICATION_FHIR_JSON) ||
                acceptableContentTypes.contains(MediaType.APPLICATION_JSON)) {
            return Format.JSON;
        } else if (acceptableContentTypes.contains(com.ibm.watson.health.fhir.core.FHIRMediaType.APPLICATION_FHIR_XML) ||
