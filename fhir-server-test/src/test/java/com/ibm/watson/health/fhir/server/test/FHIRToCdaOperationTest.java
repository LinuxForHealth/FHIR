...
public class FHIRToCdaOperationTest extends FHIRServerTestBase {
    ...
    public void testInvalidDocumentWithValidation() throws Exception {
        ...
        com.ibm.watson.health.fhir.model.type.String title = string("Invalid Document");
    ...
    private Bundle buildDocument() throws Exception {
        ...
        com.ibm.watson.health.fhir.model.type.String title = string("Sample Document");
     ...
     * @throws Exception
     */
    private Bundle createCCD(DateTime date, com.ibm.watson.health.fhir.model.type.String title, CompositionStatus status)
            throws Exception {
    ...
    private Parameters createParameters(Bundle documentBundle, Boolean validate) throws Exception {
        ...
        if (validate != null) {
            parametersBuilder.parameter(Parameter.builder().name(string("validateFHIR"))
                    .value(com.ibm.watson.health.fhir.model.type.Boolean.of(validate)).build());
        }
