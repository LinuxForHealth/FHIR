...
public abstract class FHIRServerTestBase extends FHIRModelTestBase {
    ...
    protected boolean isComparmentSearchSupported() throws Exception {
        ...
        for (Extension e : conf.getExtension()) {
            if (e.getUrl().contains("persistenceType") && (((com.ibm.watson.health.fhir.model.type.String) e.getValue())
                    .getValue().contains("FHIRPersistenceJDBCImpl")
                    || ((com.ibm.watson.health.fhir.model.type.String) e.getValue()).getValue()
    ...
    protected Patient setUniqueFamilyName(Patient patient, String uniqueName) {
        List<com.ibm.watson.health.fhir.model.type.String> familyList = new ArrayList<com.ibm.watson.health.fhir.model.type.String>();
