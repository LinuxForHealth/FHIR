...
public class MultiDataStoreTest extends FHIRServerTestBase {
    ...
    public void testCreatePractitioner() throws Exception {
        ...
        practitioner.withId(objFactory.createId().withValue(practitionerId));
    ...
    public void testCreateMedicationAdministration() throws Exception {
        ...
        medadmin.withId(objFactory.createId().withValue(medadminId));
    ...
    public void testCreateObservation() throws Exception {
        ...
        observation.withId(objFactory.createId().withValue(observationId));
    ...
    public void testInvalidDataStores() throws Exception {
        // Verify that the various resources do not exist in the datastores they are not supposed to be in.
