...
public class FHIROperationTest extends FHIRServerTestBase {
    ...
    public void testCreateAllergyIntolerance() throws Exception {
        ...
        // it.
        response = target.path("AllergyIntolerance/" + allergyIntoleranceId).request(MediaType.APPLICATION_JSON_FHIR)
                .get();
        assertResponse(response, Response.Status.OK.getStatusCode());
    ...
    public void testPostHelloOperation() throws Exception {
        ...
        assertEquals(((com.ibm.watsonhealth.fhir.model.type.String) output.getParameter().get(0).getValue()).getValue(),
                message);
    }
