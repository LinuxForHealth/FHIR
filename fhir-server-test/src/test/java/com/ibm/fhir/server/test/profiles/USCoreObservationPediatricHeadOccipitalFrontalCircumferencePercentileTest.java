 ...
 */
public class USCoreObservationPediatricHeadOccipitalFrontalCircumferencePercentileTest extends ProfilesTestBase {

    private static final String CLASSNAME = USCoreObservationPediatricHeadOccipitalFrontalCircumferencePercentileTest.class.getName();
    ...
    public void loadObservation1() throws Exception {
        String resource = "json/profiles/fhir-ig-us-core/Observation-ofc-percentile.json";
