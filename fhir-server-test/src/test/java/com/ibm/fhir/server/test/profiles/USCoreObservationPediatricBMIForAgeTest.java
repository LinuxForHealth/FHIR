 ...
 */
public class USCoreObservationPediatricBMIForAgeTest extends ProfilesTestBase {

    private static final String CLASSNAME = USCoreObservationPediatricBMIForAgeTest.class.getName();
    ...
    public void loadObservation1() throws Exception {
        String resource = "json/profiles/fhir-ig-us-core/Observation-pediatric-bmi-example.json";
