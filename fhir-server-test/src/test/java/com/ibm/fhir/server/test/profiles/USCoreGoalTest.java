 ...
 */
public class USCoreGoalTest extends ProfilesTestBase {
    ...
    public void loadGoal1() throws Exception {
        String resource = "json/profiles/fhir-ig-us-core/Goal-goal-1.json";
        WebTarget target = getWebTarget();

        Goal goal = TestUtil.readExampleResource(resource);
