 ...
 */
public class USCoreImmunizationTest extends ProfilesTestBase {
    ...
    public void loadImmunization1() throws Exception {
        String resource = "json/profiles/fhir-ig-us-core/Immunization-imm-1.json";
        WebTarget target = getWebTarget();

        Immunization Immunization = TestUtil.readExampleResource(resource);
