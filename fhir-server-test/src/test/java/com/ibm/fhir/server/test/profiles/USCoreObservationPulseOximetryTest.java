...
public class USCoreObservationPulseOximetryTest extends ProfilesTestBase {
    ...
    private static final String CLASSNAME = USCoreObservationPulseOximetryTest.class.getName();
    ...
    public void loadObservation1() throws Exception {
        String resource = "json/profiles/fhir-ig-us-core/Observation-satO2-fiO2.json";
