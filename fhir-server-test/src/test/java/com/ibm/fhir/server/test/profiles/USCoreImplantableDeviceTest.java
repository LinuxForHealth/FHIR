 ...
 */
public class USCoreImplantableDeviceTest extends ProfilesTestBase {
    ...
    public void loadDevice1() throws Exception {
        String resource = "json/profiles/fhir-ig-us-core/Device-udi-1.json";
        WebTarget target = getWebTarget();

        Device Device = TestUtil.readExampleResource(resource);
    ...
    public void loadDevice2() throws Exception {
        String resource = "json/profiles/fhir-ig-us-core/Device-udi-2.json";
        WebTarget target = getWebTarget();
    ...
    public void loadDevice3() throws Exception {
        String resource = "json/profiles/fhir-ig-us-core/Device-udi-3.json";
        WebTarget target = getWebTarget();
