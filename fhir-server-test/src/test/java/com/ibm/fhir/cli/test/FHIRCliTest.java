...
public class FHIRCliTest extends FHIRServerTestBase {
    ...
    public void testMetadataToConsole() throws Exception {
        ...
        verifyConsoleOutput("IBM FHIR Server", "(C) Copyright IBM Corporation 2016, 2020", "4.0.0");
    }
    ...
    public void testMetadataToFile() throws Exception {
        ...
        verifyFileContents("metadata.json", "IBM FHIR Server", "(C) Copyright IBM Corporation 2016, 2020", "4.0.0");
    }
