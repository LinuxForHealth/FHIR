...
import static org.linuxforhealth.fhir.model.type.code.SearchParamType.DATE;
import static org.linuxforhealth.fhir.model.type.code.SearchParamType.NUMBER;
import static org.linuxforhealth.fhir.model.type.code.SearchParamType.QUANTITY;
import static org.linuxforhealth.fhir.model.type.code.SearchParamType.REFERENCE;
import static org.linuxforhealth.fhir.model.type.code.SearchParamType.STRING;
import static org.linuxforhealth.fhir.model.type.code.SearchParamType.TOKEN;
import static org.linuxforhealth.fhir.model.type.code.SearchParamType.URI;
import static org.linuxforhealth.fhir.search.date.DateTimeHandler.generateTimestamp;
...
import org.linuxforhealth.fhir.persistence.scout.SearchParameters.BigDec;
import org.linuxforhealth.fhir.persistence.scout.SearchParameters.BigInt;
import org.linuxforhealth.fhir.persistence.scout.SearchParameters.LatLngValue;
...
public class ParameterExtractionVisitor extends DefaultVisitor {
    ...
    @Override
    public boolean visit(java.lang.String elementName, int elementIndex, org.linuxforhealth.fhir.model.type.Boolean _boolean) {
    ...
    @Override
    public boolean visit(java.lang.String elementName, int elementIndex, org.linuxforhealth.fhir.model.type.Canonical canonical) {
    ...
    @Override
    public boolean visit(java.lang.String elementName, int elementIndex, org.linuxforhealth.fhir.model.type.Code code) {
        if (code.hasValue()) {
            if (!TOKEN.equals(searchParamType)) {
    ...
    @Override
    public boolean visit(java.lang.String elementName, int elementIndex, org.linuxforhealth.fhir.model.type.Date date) {
        if (date.hasValue()) {
    ...
    @Override
    public boolean visit(java.lang.String elementName, int elementIndex, org.linuxforhealth.fhir.model.type.DateTime dateTime) {
    ...
    @Override
    public boolean visit(java.lang.String elementName, int elementIndex, org.linuxforhealth.fhir.model.type.Decimal decimal) {
    ...
    @Override
    public boolean visit(java.lang.String elementName, int elementIndex, org.linuxforhealth.fhir.model.type.Id id) {
        if (id.hasValue()) {
            if (!TOKEN.equals(searchParamType)) {
    ...
    @Override
    public boolean visit(java.lang.String elementName, int elementIndex, org.linuxforhealth.fhir.model.type.Instant instant) {
        if (instant.hasValue()) {
    ...
    @Override
    public boolean visit(java.lang.String elementName, int elementIndex, org.linuxforhealth.fhir.model.type.Integer integer) {
        if (integer.hasValue()) {
            if (!NUMBER.equals(searchParamType)) {
    ...
    @Override
    public boolean visit(String elementName, int elementIndex, org.linuxforhealth.fhir.model.type.String value) {
        if (value.hasValue()) {
    ...
    public boolean visit(java.lang.String elementName, int elementIndex, Address address) {
        ...
        for (org.linuxforhealth.fhir.model.type.String aLine : address.getLine()) {
    ...
    public boolean visit(java.lang.String elementName, int elementIndex, HumanName humanName) {
        ...
        for (org.linuxforhealth.fhir.model.type.String given : humanName.getGiven()) {
            addStringParam(given.getValue());
        }
        for (org.linuxforhealth.fhir.model.type.String prefix : humanName.getPrefix()) {
            addStringParam(prefix.getValue());
        }
        for (org.linuxforhealth.fhir.model.type.String suffix : humanName.getSuffix()) {
