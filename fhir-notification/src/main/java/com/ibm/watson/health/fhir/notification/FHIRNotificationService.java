...
public class FHIRNotificationService implements FHIRPersistenceInterceptor {
     ...
     * (non-Javadoc)
     * @see
     * com.ibm.watson.health.fhir.persistence.interceptor.FHIRPersistenceInterceptor#afterCreate(com.ibm.watson.health.
     ...
     * (non-Javadoc)
     * @see
     * com.ibm.watson.health.fhir.persistence.interceptor.FHIRPersistenceInterceptor#afterUpdate(com.ibm.watson.health.
     * fhir.persistence.interceptor.FHIRPersistenceEvent)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * com.ibm.watson.health.fhir.persistence.interceptor.FHIRPersistenceInterceptor#beforeCreate(com.ibm.watson.health.
     * fhir.persistence.interceptor.FHIRPersistenceEvent)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * com.ibm.watson.health.fhir.persistence.interceptor.FHIRPersistenceInterceptor#beforeUpdate(com.ibm.watson.health.
     * fhir.persistence.interceptor.FHIRPersistenceEvent)
     */
    @Override
