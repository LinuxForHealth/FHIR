...
public class TaskManager implements ITaskCollector {
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.task.api.ITaskCollector#makeTaskGroup(com.ibm.watson.health.task.api.ITaskGroup, java.lang.Runnable)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.task.api.ITaskCollector#start()
     */
    @Override
