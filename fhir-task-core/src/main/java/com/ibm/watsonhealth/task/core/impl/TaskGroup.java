...
public class TaskGroup implements ITaskGroup {
    ...
    /* (non-Javadoc)
     * @see com.ibm.watsonhealth.task.api.ITaskGroup#getTaskId()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watsonhealth.task.api.ITaskGroup#taskCompletionCallback(com.ibm.watsonhealth.task.api.ITaskGroup)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watsonhealth.task.api.ITaskGroup#addParent(com.ibm.watsonhealth.task.api.ITaskGroup)
     */
    @Override
