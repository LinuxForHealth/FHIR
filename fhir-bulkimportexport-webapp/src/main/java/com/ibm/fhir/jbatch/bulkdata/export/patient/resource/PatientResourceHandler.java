 ...
 */
package com.ibm.fhir.jbatch.bulkdata.export.patient.resource;
...
public class PatientResourceHandler {
    ...
    public void fillChunkDataBuffer(List<String> patientIds) throws Exception {
        boolean isDoDuplicationCheck = ConfigurationFactory.getInstance().shouldSourceCheckDuplicate(ctx.getSource());
