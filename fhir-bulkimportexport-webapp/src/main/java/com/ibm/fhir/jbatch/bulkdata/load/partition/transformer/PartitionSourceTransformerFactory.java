 ...
 */
package com.ibm.fhir.jbatch.bulkdata.load.partition.transformer;
...
import com.ibm.fhir.jbatch.bulkdata.load.partition.transformer.impl.FileTransformer;
import com.ibm.fhir.jbatch.bulkdata.load.partition.transformer.impl.HttpsTransformer;
import com.ibm.fhir.jbatch.bulkdata.load.partition.transformer.impl.S3Transformer;
...
public class PartitionSourceTransformerFactory {
    ...
    public static List<BulkDataSource> transformToSources(String source, String dataSourcesInfo) throws FHIRException {
        ...
        for (JsonValue jsonValue : dataSourceArray) {
            ...
            String type = dataSourceInfo.getString(IMPORT_INPUT_RESOURCE_TYPE);
            String location = dataSourceInfo.getString(IMPORT_INPUT_RESOURCE_URL);
