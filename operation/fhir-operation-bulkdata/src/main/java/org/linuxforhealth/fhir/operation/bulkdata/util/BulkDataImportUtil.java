    ...
    public String retrieveInputFormat() throws FHIROperationException {
        try {
            ...
            while (iter.hasNext()) {
                ...
                String val = node.asElementNode().element().as(org.linuxforhealth.fhir.model.type.String.class).getValue();
    ...
    public List<Input> retrieveInputs(FHIRVersionParam fhirVersion) throws FHIROperationException {
        ...
        try {
            ...
            while (iter.hasNext()) {
                ...
                String type =
                        ((FHIRPathElementNode) resultPartType.iterator().next()).element().as(org.linuxforhealth.fhir.model.type.String.class).getValue();
                ...
                String url =
                        ((FHIRPathElementNode) resultPartUrl.iterator().next()).element().as(org.linuxforhealth.fhir.model.type.Url.class).getValue();
            ...
            while (iter.hasNext()) {
                ...
                while (iterEncoding.hasNext()) {
                    String contentEncoding =
                            ((FHIRPathElementNode) iterEncoding.next()).element().as(org.linuxforhealth.fhir.model.type.String.class).getValue();
