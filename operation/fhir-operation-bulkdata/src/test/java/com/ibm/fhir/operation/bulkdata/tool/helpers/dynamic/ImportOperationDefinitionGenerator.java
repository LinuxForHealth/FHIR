...
public class ImportOperationDefinitionGenerator {
    ...
    public static void main(String[] args) {
        ...
        builder.id("import")
                ...
                .code(Code.of("import"))
                .system(com.ibm.fhir.model.type.Boolean.TRUE)
                .type(com.ibm.fhir.model.type.Boolean.FALSE)
                .instance(com.ibm.fhir.model.type.Boolean.FALSE)
                .contact(contact);
        ...
        OperationDefinition.Parameter part1 =
                OperationDefinition.Parameter.builder()
                        .name(Code.code("type"))
                        .min(com.ibm.fhir.model.type.Integer.of(1))
                        .max(string("1"))
        ...
        OperationDefinition.Parameter part4 =
                OperationDefinition.Parameter.builder()
                        ...
                        .min(com.ibm.fhir.model.type.Integer.of(0))
                        .max(string("*"))
