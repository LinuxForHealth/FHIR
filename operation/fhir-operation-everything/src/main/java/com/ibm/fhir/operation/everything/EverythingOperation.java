...
public class EverythingOperation extends AbstractOperation {
    ...
    private void addIncludesSearchParameters(String compartmentMemberType, MultivaluedMap<String, String> searchParameters,
        ...
        if (compartmentMemberType.equals(ResourceType.ADVERSE_EVENT.value())) {
            addSearchParameterIfNotExcluded(compartmentMemberType, "location", ResourceType.LOCATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "recorder", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "subject", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "substance", ResourceType.MEDICATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
        } else if (compartmentMemberType.equals(ResourceType.ALLERGY_INTOLERANCE.value())) {
            addSearchParameterIfNotExcluded(compartmentMemberType, "recorder", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "asserter", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
        } else if (compartmentMemberType.equals(ResourceType.APPOINTMENT.value())) {
            addSearchParameterIfNotExcluded(compartmentMemberType, "location", ResourceType.LOCATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "practitioner", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
        } else if (compartmentMemberType.equals(ResourceType.APPOINTMENT_RESPONSE.value())) {
            addSearchParameterIfNotExcluded(compartmentMemberType, "actor", ResourceType.LOCATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "actor", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "location", ResourceType.LOCATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "practitioner", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
        } else if (compartmentMemberType.equals(ResourceType.ACCOUNT.value())) {
            addSearchParameterIfNotExcluded(compartmentMemberType, "owner", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "subject", ResourceType.LOCATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "subject", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "subject", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
        } else if (compartmentMemberType.equals(ResourceType.AUDIT_EVENT.value())) {
            addSearchParameterIfNotExcluded(compartmentMemberType, "agent", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "agent", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "source", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "source", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
        } else if (compartmentMemberType.equals(ResourceType.BASIC.value())) {
            addSearchParameterIfNotExcluded(compartmentMemberType, "author", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "author", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
        } else if (compartmentMemberType.equals(ResourceType.CARE_PLAN.value())) {
            addSearchParameterIfNotExcluded(compartmentMemberType, "performer", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "performer", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
        } else if (compartmentMemberType.equals(ResourceType.CARE_TEAM.value())) {
            addSearchParameterIfNotExcluded(compartmentMemberType, "participant", ResourceType.ORGANIZATION,searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "participant", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
        } else if (compartmentMemberType.equals("ChargeHistory")) {
            addSearchParameterIfNotExcluded(compartmentMemberType, "service", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "enterer", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "performer-actor", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
        } else if (compartmentMemberType.equals(ResourceType.CLAIM.value())) {
            addSearchParameterIfNotExcluded(compartmentMemberType, "care-team", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "care-team", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "enterer", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "facility", ResourceType.LOCATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "insurer", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "payee", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "payee", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "provider", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "provider", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
        } else if (compartmentMemberType.equals(ResourceType.CLAIM_RESPONSE.value())) {
            addSearchParameterIfNotExcluded(compartmentMemberType, "insurer", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "requestor", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "requestor", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
        } else if (compartmentMemberType.equals(ResourceType.CLINICAL_IMPRESSION.value())) {
            addSearchParameterIfNotExcluded(compartmentMemberType, "assessor", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
        } else if (compartmentMemberType.equals(ResourceType.COMMUNICATION.value())) {
            addSearchParameterIfNotExcluded(compartmentMemberType, "recipient", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "sender", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
        } else if (compartmentMemberType.equals(ResourceType.COMPOSITION.value())) {
            addSearchParameterIfNotExcluded(compartmentMemberType, "attester", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "author", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            ...
            addSearchParameterIfNotExcluded(compartmentMemberType, "recipient", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "recipient", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "requester", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "requester", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "sender", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "sender", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
        } else if (compartmentMemberType.equals(ResourceType.CONSENT.value())) {
            addSearchParameterIfNotExcluded(compartmentMemberType, "actor", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "actor", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "consentor", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "consentor", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "organization", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
        } else if (compartmentMemberType.equals(ResourceType.COVERAGE.value())) {
            addSearchParameterIfNotExcluded(compartmentMemberType, "payor", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "policy-holder", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            ...
            addSearchParameterIfNotExcluded(compartmentMemberType, "performer", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "performer", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "results-interpreter", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "results-interpreter", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "subject", ResourceType.LOCATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            ...
            addSearchParameterIfNotExcluded(compartmentMemberType, "authenticator", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "authenticator", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "author", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "author", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "custodian", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "subject", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
        } else if (compartmentMemberType.equals(ResourceType.ENCOUNTER.value())) {
            addSearchParameterIfNotExcluded(compartmentMemberType, "location", ResourceType.LOCATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "service-provider", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "participant", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
        } else if (compartmentMemberType.equals(ResourceType.EPISODE_OF_CARE.value())) {
            addSearchParameterIfNotExcluded(compartmentMemberType, "care-manager", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "organization", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            ...
            addSearchParameterIfNotExcluded(compartmentMemberType, "author", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "subject", ResourceType.LOCATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "subject", ResourceType.MEDICATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "subject", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "subject", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            ...
            addSearchParameterIfNotExcluded(compartmentMemberType, "member", ResourceType.MEDICATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "member", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "managing-entity", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "managing-entity", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
        } else if (compartmentMemberType.equals(ResourceType.IMAGING_STUDY.value())) {
            addSearchParameterIfNotExcluded(compartmentMemberType, "interpreter", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "performer", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "referrer", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
        } else if (compartmentMemberType.equals(ResourceType.IMMUNIZATION.value())) {
            addSearchParameterIfNotExcluded(compartmentMemberType, "location", ResourceType.LOCATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "manufacturer", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "performer", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "performer", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
        } else if (compartmentMemberType.equals(ResourceType.INVOICE.value())) {
            addSearchParameterIfNotExcluded(compartmentMemberType, "issuer", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "participant", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "participant", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "recipient", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            ...
            addSearchParameterIfNotExcluded(compartmentMemberType, "reporter", ResourceType.LOCATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "reporter", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "reporter", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "subject", ResourceType.LOCATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "subject", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
        } else if (compartmentMemberType.equals(ResourceType.MEDIA.value())) {
            addSearchParameterIfNotExcluded(compartmentMemberType, "operator", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "operator", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "subject", ResourceType.LOCATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "subject", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
        } else if (compartmentMemberType.equals(ResourceType.MEDICATION_ADMINISTRATION.value())) {
            addSearchParameterIfNotExcluded(compartmentMemberType, "medication", ResourceType.MEDICATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "performer", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
        } else if (compartmentMemberType.equals(ResourceType.MEDICATION_DISPENSE.value())) {
            addSearchParameterIfNotExcluded(compartmentMemberType, "destination", ResourceType.LOCATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "medication", ResourceType.MEDICATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "performer", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "receiver", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "responsibleparty", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
        } else if (compartmentMemberType.equals(ResourceType.MEDICATION_REQUEST.value())) {
            addSearchParameterIfNotExcluded(compartmentMemberType, "intended-dispenser", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "intended-performer", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "intended-performer", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "medication", ResourceType.MEDICATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "requester", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "requester", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            ...
            addSearchParameterIfNotExcluded(compartmentMemberType, "general-practitioner", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "general-practitioner", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "organization", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            ...
            addSearchParameterIfNotExcluded(compartmentMemberType, "collector", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "subject", ResourceType.LOCATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
        } else if (compartmentMemberType.equals(ResourceType.SUPPLY_DELIVERY.value())) {
            addSearchParameterIfNotExcluded(compartmentMemberType, "receiver", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "supplier", ResourceType.ORGANIZATION, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            addSearchParameterIfNotExcluded(compartmentMemberType, "supplier", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
            ...
            addSearchParameterIfNotExcluded(compartmentMemberType, "prescriber", ResourceType.PRACTITIONER, searchParameters, allowedIncludes, extraResources, supportedSearchParametersMap);
        }
