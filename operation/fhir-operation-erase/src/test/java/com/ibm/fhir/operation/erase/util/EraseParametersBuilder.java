...
public final class EraseParametersBuilder {
    ...
    public EraseParametersBuilder badReason() {
        parameters.add(Parameter.builder().name(string(REASON)).value(com.ibm.fhir.model.type.Integer.of("1")).build());
        return this;
    }
    ...
    public EraseParametersBuilder badPatient() {
        parameters.add(Parameter.builder().name(string(PATIENT)).value(com.ibm.fhir.model.type.Integer.of("1")).build());
        return this;
    }
    ...
    public EraseParametersBuilder version(Integer version) {
        parameters.add(Parameter.builder().name(string(VERSION)).value(com.ibm.fhir.model.type.Integer.of(version)).build());
        return this;
    }
    ...
    public EraseParametersBuilder badId() {
        parameters.add(Parameter.builder().name(string(ID)).value(com.ibm.fhir.model.type.Integer.of("1")).build());
        return this;
    }
