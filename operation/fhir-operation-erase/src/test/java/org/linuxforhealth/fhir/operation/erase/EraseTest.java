...
import org.linuxforhealth.fhir.operation.erase.impl.EraseRestImpl;
import org.linuxforhealth.fhir.operation.erase.mock.MockAuditLogService;
import org.linuxforhealth.fhir.operation.erase.mock.MockFHIRResourceHelpers;
import org.linuxforhealth.fhir.operation.erase.mock.MockHttpServletRequest;
import org.linuxforhealth.fhir.operation.erase.mock.MockSecurityContext;
import org.linuxforhealth.fhir.operation.erase.util.EraseParametersBuilder;
...
public class EraseTest {
    ...
    @Test(expectedExceptions = {org.linuxforhealth.fhir.exception.FHIROperationException.class})
