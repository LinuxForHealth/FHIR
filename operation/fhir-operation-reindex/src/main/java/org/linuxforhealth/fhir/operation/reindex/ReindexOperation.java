            ...
            if (parameters != null) {
                for (Parameters.Parameter parameter : parameters.getParameter()) {
                    ...
                    if (PARAM_TSTAMP.equals(parameterNameValue)
                            ...
                            && parameter.getValue().is(org.linuxforhealth.fhir.model.type.String.class)) {
                        ...
                        String lrIdsString = parameter.getValue().as(org.linuxforhealth.fhir.model.type.String.class).getValue();
                        if (lrIdsString != null) {
                        ...
                        Boolean val = parameter.getValue().as(org.linuxforhealth.fhir.model.type.Boolean.class).getValue();
                        if (val != null) {
                            if (val.booleanValue()) {
                        ...
                        resourceLogicalId = parameter.getValue().as(org.linuxforhealth.fhir.model.type.String.class).getValue();
