...
public class ReindexOperation extends AbstractOperation {
    ...
    protected Parameters doInvoke(FHIROperationContext operationContext, Class<? extends Resource> resourceType,
        ...
        try {
            ...
            if (!pl.isReindexSupported()) {
                throw new FHIROperationException("Persistence layer does not support the reindex operation");
            }
            ...
            try {
                ...
                OperationOutcome operationOutcome = pl.reindex(context, tstamp, resourceCount);
