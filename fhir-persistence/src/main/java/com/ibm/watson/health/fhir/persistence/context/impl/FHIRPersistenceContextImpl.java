...
package com.ibm.watson.health.fhir.persistence.context.impl;
...
public class FHIRPersistenceContextImpl implements FHIRPersistenceContext {
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.context.FHIRPersistenceContext#getPersistenceEvent()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.context.FHIRPersistenceContext#getHistoryContext()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.context.FHIRPersistenceContext#getSearchContext()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.context.FHIRPersistenceContext#includeDeleted()
     */
    @Override
