...
import static com.ibm.watson.health.fhir.config.FHIRConfiguration.PROPERTY_PERSISTENCE_FACTORY;
...
public class FHIRPersistenceHelper implements PersistenceHelper {
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.helper.PersistenceHelper#getFHIRPersistenceImplementation()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.ibm.watson.health.fhir.persistence.helper.PersistenceHelper#getFHIRPersistenceImplementation(java.lang.String)
     */
    @Override
