...
import org.linuxforhealth.fhir.model.resource.Resource.Builder;
...
public class FHIRPersistenceUtil {
     ...
     * @return
     */
    public static org.linuxforhealth.fhir.model.type.Instant getUpdateTime() {
    ...
    public static <T extends Resource> T copyAndSetResourceMetaFields(T resource, String logicalId, int newVersionNumber, org.linuxforhealth.fhir.model.type.Instant lastUpdated) {
