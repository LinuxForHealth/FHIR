    ...
    public Basic getBasicResource() throws Exception {
        ...
        Coding tag3 =
                Coding.builder()
                        ...
                        .code(Code.of(TAG4))
                        .display(org.linuxforhealth.fhir.model.type.String.of(TAG4TEXT))
                        .build();
        ...
        return basic.toBuilder()
                .meta(meta)
                .author(Reference.builder().reference(org.linuxforhealth.fhir.model.type.String.of(AUTHOR)).build())
                .build();
    }
