...
public abstract class AbstractQueryImmunizationRecommendationTest extends AbstractPersistenceTest {
    ...
    public void testCreateImmunizationRecommendation() throws Exception {
        ...
        DateCriterion criterion = DateCriterion.builder().code(CodeableConcept.builder().text(com.ibm.watsonhealth.fhir.model.type.String.of("dateType")).build()).value(DateTime.of("2017-01-01T10:10:10Z")).build();
                
    	ImmunizationRecommendation.Recommendation rec = ImmunizationRecommendation.Recommendation
                .builder().forecastReason(CodeableConcept.builder().text(com.ibm.watsonhealth.fhir.model.type.String.of("cloudy")).build())
