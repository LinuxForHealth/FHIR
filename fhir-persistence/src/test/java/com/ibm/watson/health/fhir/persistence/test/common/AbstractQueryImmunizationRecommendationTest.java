...
import com.ibm.watson.health.fhir.model.resource.ImmunizationRecommendation;
import com.ibm.watson.health.fhir.model.resource.Resource;
import com.ibm.watson.health.fhir.model.resource.ImmunizationRecommendation.Recommendation.DateCriterion;
...
public abstract class AbstractQueryImmunizationRecommendationTest extends AbstractPersistenceTest {
    ...
    public void testCreateImmunizationRecommendation() throws Exception {
        ...
        DateCriterion criterion = DateCriterion.builder().code(CodeableConcept.builder().text(com.ibm.watson.health.fhir.model.type.String.of("dateType")).build()).value(DateTime.of("2017-01-01T10:10:10Z")).build();
                
    	ImmunizationRecommendation.Recommendation rec = ImmunizationRecommendation.Recommendation
                .builder().forecastReason(CodeableConcept.builder().text(com.ibm.watson.health.fhir.model.type.String.of("cloudy")).build())
                .vaccineCode(CodeableConcept.builder().text(com.ibm.watson.health.fhir.model.type.String.of("a vaccine")).build())
                .doseNumber(PositiveInt.of(10))
                .dateCriterion(criterion)
                .build();
    	
    	Reference patient = Reference.builder()
    			.display(com.ibm.watson.health.fhir.model.type.String.of("Pat Ient"))
    			.build();
