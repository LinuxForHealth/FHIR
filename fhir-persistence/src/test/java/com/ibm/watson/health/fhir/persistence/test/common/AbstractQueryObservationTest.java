...
//        Reference patientRef = new Reference().withReference(new com.ibm.watson.health.fhir.model.String().withValue("Patient/" + patient.getId().getValue()));
...
//        Reference deviceRef = new Reference().withReference(new com.ibm.watson.health.fhir.model.String().withValue("Device/" + device.getId().getValue()));
