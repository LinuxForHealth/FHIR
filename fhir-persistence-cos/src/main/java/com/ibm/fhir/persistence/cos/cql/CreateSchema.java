...
import static com.ibm.fhir.persistence.scout.cql.SchemaConstants.LAST_MODIFIED;
import static com.ibm.fhir.persistence.scout.cql.SchemaConstants.LOGICAL_RESOURCES;
import static com.ibm.fhir.persistence.scout.cql.SchemaConstants.PARAM_STR_LOWER_VALUES;
import static com.ibm.fhir.persistence.scout.cql.SchemaConstants.PARAM_STR_VALUES;
import static com.ibm.fhir.persistence.scout.cql.SchemaConstants.PAYLOAD_CHUNKS;
import static com.ibm.fhir.persistence.scout.cql.SchemaConstants.RESOURCE_HISTORY;
import static com.ibm.fhir.persistence.scout.cql.SchemaConstants.SYSTEM_STR_LOWER_VALUES;
import static com.ibm.fhir.persistence.scout.cql.SchemaConstants.SYSTEM_STR_VALUES;
...
public class CreateSchema {
    ...
    protected void createLogicalResourcesTable(CqlSession session) {
        ...
        final String cql = "CREATE TABLE IF NOT EXISTS " + LOGICAL_RESOURCES + " ("
                ...
                + ") WITH CLUSTERING ORDER BY (logical_id ASC, version DESC)";
