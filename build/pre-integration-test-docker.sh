...
docker-compose exec --user db2inst1 db2 bash -c 'source ./database/config/db2inst1/sqllib/db2profile; db2 activate db fhirdb'
docker-compose exec --user db2inst1 db2 bash -c 'source ./database/config/db2inst1/sqllib/db2profile; db2pd -alldbp -alldbs'
docker-compose exec --user db2inst1 db2 bash -c 'source ./database/config/db2inst1/sqllib/db2profile; db2pd -alldbs -catalogcache'
